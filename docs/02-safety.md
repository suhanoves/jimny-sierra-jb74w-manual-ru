...
!!! danger "Внимание"
    ...
    - система не сможет корректно определять скорость вращения колёс, из-за чего могут работать неправильно:
        - ESP®;
        - ABS;
        - аварийная световая сигнализация при экстренном торможении ESS;
...
- Детское удерживающее устройство против хода движения, например люльку, нельзя использовать на переднем пассажирском сиденье. Устанавливайте его на заднем сиденье.
...
!!! danger "Внимание"
    ...
    - не используйте дистанционное управление, пока автомобиль находится у дилера Suzuki, в авторизованном сервисе Suzuki, на заправке или в другом месте для осмотра и обслуживания. Если двигатель неожиданно запустится во время работ, можно получить травму;
...
!!! info "Примечание"
    ...
    Если автомобиль уже проехал затопленное место или глубокую лужу, остановитесь в безопасном месте, обратитесь к дилеру Suzuki или в авторизованный сервис Suzuki и проверьте:
