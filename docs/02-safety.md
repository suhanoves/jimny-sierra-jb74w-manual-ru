...
!!! danger "Внимание"
    Если автомобиль повреждён, загорелась предупреждающая лампа или предупреждающий зуммер указывает на неисправность, перед началом движения обратитесь к дилеру Suzuki или в авторизованный сервис Suzuki и как можно скорее проведите проверку и ремонт.
...
!!! warning "Осторожно"
    В следующих случаях обратитесь к дилеру Suzuki или в авторизованный сервис Suzuki для проверки автомобиля:
...
Если уровень электролита ниже средней отметки (3), расположенной между верхней (1) и нижней (2) отметками, долейте дистиллированную воду до верхней отметки (1). Недостаток электролита может сократить срок службы аккумулятора.
...
!!! info "Примечание"
    ...
    - при замене аккумулятора используйте аккумулятор указанного типа, не устанавливайте аккумулятор другого типа;
...
!!! danger "Внимание"
    ...
    Если заметили неисправность, обратитесь к дилеру Suzuki или в авторизованный сервис Suzuki для проверки автомобиля.
...
!!! danger "Внимание"
    Не перевозите в салоне ёмкости с топливом или химическими веществами, аэрозольные баллоны и другие подобные предметы. Это может привести к возгоранию или взрыву.
...
См. также: [использование детских удерживающих устройств](#использование-детских-удерживающих-устройств) и [выбор детского удерживающего устройства](03-before-driving.md#выбор-детского-удерживающего-устройства).
...
!!! danger "Внимание"
    ...
    Если ремень проходит по шее или подбородку ребёнка либо не фиксирует его в области таза, используйте детское удерживающее устройство или детское сиденье-подставку и перевозите ребёнка на заднем сиденье.

    ![Ремень безопасности не должен проходить по шее ребёнка](images/02-safety/69RHS160.png){ .center-image }

    Без автолюльки ребёнок может получить тяжёлые травмы. Если ребёнок ещё не может уверенно сидеть самостоятельно или его шея недостаточно окрепла, используйте автолюльку и перевозите ребёнка на заднем сиденье.
...
- Детское удерживающее устройство против хода движения, например автолюльку, нельзя использовать на переднем пассажирском сиденье. Устанавливайте его на заднем сиденье.
- Для безопасности устанавливайте детские удерживающие устройства и детские сиденья-подставки на заднем сиденье.
- Выбирайте детское удерживающее устройство, подходящее возрасту и телосложению ребёнка.

См. также: [детские удерживающие устройства](03-before-driving.md#детские-удерживающие-устройства).

- На обеих сторонах солнцезащитного козырька пассажира наклеены предупреждения о запрете установки детского удерживающего устройства на переднее пассажирское сиденье в автомобилях с подушкой безопасности SRS переднего пассажира. Перед использованием детского удерживающего устройства обязательно прочитайте раздел [«Предупреждающая наклейка о подушке безопасности SRS переднего пассажира»](#предупреждающая-наклейка-о-подушке-безопасности-srs-переднего-пассажира).
- В этот автомобиль можно установить следующие типы детских удерживающих устройств:
    - [устройства, фиксируемые ремнём безопасности](03-before-driving.md#крепление-детского-удерживающего-устройства-ремнём-безопасности);
    - [устройства ISOFIX](03-before-driving.md#крепление-детского-удерживающего-устройства-isofix);
    - [устройства с верхним страховочным ремнём](03-before-driving.md#крепление-к-верхнему-страховочному-анкеру).
...
!!! danger "Внимание"
    ...
    Если детское удерживающее устройство или детское сиденье-подставку всё же приходится установить на переднем пассажирском сиденье, сдвиньте сиденье максимально назад и устанавливайте устройство по ходу движения.
...
!!! danger "Внимание"
    Если вы используете имплантированный кардиостимулятор или имплантируемый кардиовертер-дефибриллятор (ICD), следите, чтобы устройство не находилось ближе примерно 22 см к передатчикам системы бесключевого запуска кнопкой, показанным на схеме ниже. Радиоволны могут повлиять на работу кардиостимулятора или ICD.

    Если вы используете другое медицинское электрическое устройство, уточните у производителя медицинского устройства, может ли радиосигнал системы бесключевого запуска кнопкой повлиять на его работу.

    За дополнительной информацией обратитесь к дилеру Suzuki или в авторизованный сервис Suzuki.

![Расположение передатчиков системы бесключевого запуска кнопкой](images/02-safety/77R20040.png){ .center-image }
...
- [внутреннее зеркало и наружные зеркала](03-before-driving.md#регулировка-элементов).

![Регулировка водительского места перед поездкой](images/02-safety/80J014.png){ .center-image }

!!! danger "Внимание"
    Не регулируйте рулевое колесо, сиденье, внутреннее зеркало или наружные зеркала во время движения.
...
!!! danger "Внимание"
    ...
    ![Пример оригинального напольного коврика Suzuki](images/02-safety/72M10201.png){ .center-image }
...
!!! danger "Внимание"
    ...
    Если в салоне ощущается запах выхлопных газов, полностью откройте все окна, переведите кондиционер или отопитель в режим подачи наружного воздуха и включите вентилятор на высокую скорость. Если запах не исчезает даже после проветривания, как можно скорее обратитесь к дилеру Suzuki или в авторизованный сервис Suzuki для проверки автомобиля.
...
!!! danger "Внимание"
    ...
    Не запускайте двигатель дистанционно, если в автомобиле находятся пассажиры, дети или животные. Стеклоподъёмники могут внезапно начать работать, что может привести к серьёзной аварии.
    ...
    Радиосигнал дистанционного управления может быть нестабильным в зависимости от окружающих условий. Если система не сработала, не нажимайте переключатели без необходимости. Чтобы избежать непреднамеренного запуска двигателя, используйте дистанционный запуск только там, где можно хорошо проверить безопасность вокруг автомобиля.
    ...
    В выхлопных газах содержится бесцветный и не имеющий запаха угарный газ. Вдыхание угарного газа может привести к тяжёлому вреду здоровью или смерти. Перед использованием убедитесь, что в автомобиле нет пассажиров, детей и животных, а условия позволяют безопасно использовать функцию.
    ...
    Перед использованием убедитесь, что вентиляционные отверстия и глушитель не забиты.

    Используйте дистанционный запуск только после проверки, что рядом с автомобилем нет легко воспламеняющихся предметов, например масла или сухих листьев, и что на автомобиль не надет чехол.
    ...
    - не используйте дистанционное управление, пока автомобиль находится у дилера Suzuki, в авторизованном сервисе Suzuki, на заправке или в другом месте для осмотра и обслуживания. Если двигатель неожиданно запустится во время работ, можно защемить или травмировать руки и ноги;
...
!!! tip "Подсказка"
    Используйте дистанционное управление кондиционером только при необходимости, учитывая окружающих и воздействие на окружающую среду.
...
- напряжение свинцово-кислотной аккумуляторной батареи снижено;
...
Счётчик включений сбрасывается каждый раз, когда двигатель запускают выключателем двигателя в автомобиле и он работает около минуты.
...
!!! warning "Осторожно"
    ...
    Нельзя полагаться только на зеркала заднего вида или камеру заднего вида, если она установлена. При движении вперёд или назад выйдите из автомобиля и проверьте окружающую обстановку своими глазами.
...
На длинном спуске используйте торможение двигателем [※](#engine-brake-note) вместе с рабочим тормозом. Уберите ногу с педали акселератора и переключайтесь на пониженную передачу в соответствии со скоростью движения.
...
<span id="engine-brake-note"></span>※ Торможение двигателем — это замедление, которое возникает, когда во время движения вы отпускаете педаль акселератора. Чем ниже передача, тем сильнее эффект торможения двигателем.
...
!!! warning "Осторожно"
    На мокрой, обледеневшей или заснеженной дороге избегайте резкого трогания, резкого ускорения, резкого торможения, резких поворотов и резкого торможения двигателем.
...
!!! info "Примечание"
    Движение по затопленным местам и глубоким лужам может привести к остановке двигателя, неисправности электрооборудования, повреждению двигателя и другим поломкам.

    Если всё же приходится ехать по воде:

    - не въезжайте туда, где глубина воды составляет 30 см и более;
    ...
    Если автомобиль уже проехал затопленное место или глубокую лужу, убедитесь в безопасности вокруг, несколько раз нажмите педаль тормоза на низкой скорости и проверьте эффективность торможения.

    Затем остановитесь в безопасном месте, обратитесь к дилеру Suzuki или в авторизованный сервис Suzuki и проверьте:
...
Если вода быстро прибывает и автомобиль может оказаться затопленным, действуйте как при попадании автомобиля в воду.

См. также: [система автоматической остановки двигателя](04-driving.md#система-автоматической-остановки-двигателя-на-холостом-ходу) и [если автомобиль оказался в воде](07-emergency.md#если-автомобиль-оказался-в-воде).
...
См. также: [предупреждающие лампы](01-quick-guide.md#предупреждающие-лампы) и [сообщения многофункционального информационного дисплея](03-before-driving.md#сообщения-многофункционального-информационного-дисплея).
...
Если нашли неисправность, обратитесь к дилеру Suzuki или в авторизованный сервис Suzuki.
...
Как можно скорее обратитесь к дилеру Suzuki или в авторизованный сервис Suzuki для проверки.

В дисковых тормозных колодках Suzuki предусмотрен индикатор износа: когда колодки приближаются к предельному износу, во время движения появляется металлический звук.
...
!!! warning "Осторожно"
    Если тормоза стали работать хуже, торможение справа и слева стало неравномерным, ход педали увеличился или тормоз стал подклинивать, как можно скорее обратитесь к дилеру Suzuki или в авторизованный сервис Suzuki для проверки.
...
!!! danger "Внимание"
    При стоянке под солнцем не оставляйте в салоне зажигалки, аэрозольные баллоны, пластиковые изделия, например очки, карты и футляры для CD, а также банки с газированными напитками.
...
!!! danger "Внимание"
    Перед открытием крышки топливного бака коснитесь кузова автомобиля или металлической части заправочной колонки, чтобы снять статическое электричество ([※](#fuel-static-note)). Если на теле накоплен статический заряд, искра может воспламенить топливо и вызвать ожог.
    ...
    <span id="fuel-static-note"></span>※ В сухом воздухе на теле легче накапливается статическое электричество. При многослойной одежде статический заряд также может возникать из-за трения тканей, поэтому в сухой сезон будьте особенно осторожны.
    ...
    Если сработала автоматическая остановка пистолета, завершите заправку ([※](#fuel-autostop-note)). Не доливайте топливо после автоматической остановки: топливо может перелиться.

    ![Не доливайте топливо после автоматической остановки](images/02-safety/80J1005.png){ .center-image }

    <span id="fuel-autostop-note"></span>※ На некоторых заправочных колонках автоматическая остановка может сработать рано и заправка может быть затруднена. Следуйте указаниям сотрудника заправочной станции.
    ...
    После заправки верните заправочный пистолет на место, установите крышку топливного бака и закрутите её до двух и более щелчков. Если крышка закрыта неплотно, топливо может вытечь или возникнуть пожар.
...
!!! info "Примечание"
    Не используйте этилированный бензин, низкокачественный бензин и другие виды топлива, например спиртовое топливо или дизельное топливо. Это может повредить двигатель и топливную систему.
...
### Проверяйте положение селектора и индикацию на комбинации приборов

При запуске двигателя и перед выходом из автомобиля выбирайте `P`, при движении вперёд - `D`, при движении назад - `R`. Перед движением визуально убедитесь, что индикация положения селектора на комбинации приборов показывает `P`, `D` или `R`.
...
!!! danger "Внимание"
    Не приближайте лицо или грудь к рулевому колесу или панели приборов и не кладите туда ноги. При срабатывании фронтальных подушек безопасности SRS сильный удар может привести к тяжёлым травмам.

    При срабатывании боковых подушек безопасности SRS или шторок безопасности SRS сильный удар может привести к тяжёлым травмам. Не высовывайте руки из окна, не прислоняйтесь к двери. Пассажирам заднего сиденья не следует обхватывать спинку переднего сиденья.
...
!!! danger "Внимание"
    ...
    При срабатывании боковых подушек безопасности SRS или шторок безопасности SRS предметы могут отлететь или помешать нормальному раскрытию, что может привести к тяжёлым травмам. Не устанавливайте держатели стаканов, крючки, вешалки и другие аксессуары рядом с дверями и не ставьте зонты в этой зоне.

![Не размещайте аксессуары рядом с дверью и боковыми подушками](images/02-safety/59RN02200.png){ .center-image }

<span id="предупреждающая-наклейка-о-подушке-безопасности-srs-переднего-пассажира"></span>

### Предупреждающая наклейка о фронтальной подушке безопасности SRS переднего пассажира
...
![Предупреждающая наклейка о фронтальной подушке безопасности SRS переднего пассажира](images/02-safety/72M00150.png){ .center-image }
...
| Символ | Значение |
| --- | --- |
| Запрещающий символ детского удерживающего устройства | Запрещено устанавливать на переднее пассажирское сиденье, оснащённое фронтальной подушкой безопасности SRS, детское удерживающее устройство против хода движения и перевозить в нём ребёнка. |
| Символ раскрытия подушки безопасности SRS | Показывает, что при раскрытии фронтальной подушки безопасности SRS переднего пассажира на детское удерживающее устройство против хода движения и ребёнка действует сильный удар. |
...
!!! warning "Осторожно"
    Если в режиме 4WD резко разворачивать автомобиль на крутом повороте, в узком проезде или на парковке, усилие на рулевом колесе увеличится. Кроме того, может возникнуть эффект торможения в крутом повороте [※](#tight-corner-braking-note), из-за чего возможна неожиданная авария или повреждение привода.

    <span id="tight-corner-braking-note"></span>※ Эффект торможения в крутом повороте возникает при резком повороте в режиме полного привода, когда разница вращения передних и задних колёс не поглощается. По ощущениям это похоже на торможение.
...
!!! info "Примечание"
    ...
    Если автомобиль всё же проехал водную преграду, остановитесь в безопасном месте, проверьте эффективность тормозов и обратитесь к дилеру Suzuki или в авторизованный сервис Suzuki для проверки следующих узлов:
...
- Если двигатель холодный, не повышайте резко обороты двигателя без нагрузки и не ускоряйтесь резко.
...
!!! tip "Подсказка"
    Выключатель OFF системы поддержки торможения с двумя датчиками DSBS II не отключает ESP®.
...
!!! danger "Внимание"
    Перед установкой или снятием радиостанции, аудиосистемы, устройства электронной оплаты проезда ETC и другого электрооборудования обратитесь к дилеру Suzuki или в авторизованный сервис Suzuki.
...
!!! info "Примечание"
    Перед установкой радиостанции рекомендуется проконсультироваться с дилером Suzuki или с авторизованным сервисом Suzuki по частоте, максимальной выходной мощности, месту установки антенны и другим условиям установки и эксплуатации.
...
!!! danger "Внимание"
    ...
    Перечисленные ниже работы могут повлиять на работу системы. Перед их выполнением проконсультируйтесь с дилером Suzuki или с авторизованным сервисом Suzuki:
...
!!! danger "Внимание"
    ...
    Если жидкость всё же попала в салон, как можно скорее обратитесь к дилеру Suzuki или в авторизованный сервис Suzuki для проверки автомобиля.

!!! info "Примечание"
    В подушках сиденья переднего пассажира и задних сидений могут быть встроены датчики напоминания о ремнях безопасности. Если на подушку сиденья пролился сладкий напиток, сок или другая жидкость, сразу вытрите её мягкой тканью.
...
!!! info "Примечание"
    ...
    Для замены масла и фильтра обратитесь к дилеру Suzuki или в авторизованный сервис Suzuki.
...
| API ([※1](#engine-oil-api-note)) | ILSAC ([※2](#engine-oil-ilsac-note)) | Эксплуатационные свойства масла |
| --- | --- | --- |
...
| Автомобиль | Вязкость SAE ([※3](#engine-oil-sae-note)) |
| --- | --- |
| Jimny | 5W-30 |
...
- <span id="engine-oil-api-note"></span>※1 API: класс качества моторного масла по системе Американского института нефти.
- <span id="engine-oil-ilsac-note"></span>※2 ILSAC: спецификация Международного консультативного комитета по смазочным материалам для автомобильных моторных масел. Она основана на спецификации API и указывает, что масло также имеет улучшенные характеристики по расходу топлива, долговечности и другим параметрам.
- <span id="engine-oil-sae-note"></span>※3 SAE: классификация вязкости моторного масла. Число слева от `W` обозначает вязкость при низкой температуре: чем оно меньше, тем лучше пуск двигателя в холодную погоду. Число справа обозначает вязкость при высокой температуре: чем оно больше, тем выше стойкость масла к нагреву и защитные свойства.
...
!!! info "Примечание"
    Сразу после запуска двигатель ещё не прогрет. Резкое повышение оборотов двигателя без нагрузки, резкое трогание и резкое ускорение могут привести к неисправности двигателя.

!!! tip "Подсказка"
    Расход зависит от условий, но обычно за 5 минут прогрева двигатель расходует около 160 мл топлива.

### Избегайте резкого трогания, ускорения, торможения и других резких действий

![Избегайте резкого трогания, ускорения, торможения и других резких действий](images/02-safety/76J40390.png){ .center-image }
