...
!!! danger "Внимание"
    ...
    См. также: [если корректная скорость вращения шин не определяется](04-driving.md#если-корректная-скорость-вращения-шин-не-определяется).
...
См. также: [рычаг переключения передач](04-driving.md#рычаг-переключения-передач) и [селектор передач](04-driving.md#селектор-передач).
...
См. также: [система автоматической остановки двигателя на холостом ходу](04-driving.md#система-автоматической-остановки-двигателя-на-холостом-ходу) и [если автомобиль был затоплен](07-emergency.md#если-автомобиль-был-затоплен).
...
См. также: [прокол колеса](07-emergency.md#прокол-колеса).
...
См. также: [системы помощи водителю Suzuki Safety Support](04-driving.md#suzuki-safety-support).
