...
!!! danger "Внимание"
    ...
    Радиосигнал дистанционного управления может быть нестабильным в зависимости от окружающих условий. Если система не сработала, не выполняйте команды без необходимости. Используйте дистанционный запуск только там, где можно хорошо проверить безопасность вокруг автомобиля.
...
!!! warning "Осторожно"
    ...
    Нельзя полагаться только на зеркала или камеру заднего вида. При движении вперёд или назад выйдите из автомобиля и проверьте окружающую обстановку своими глазами.
...
Торможение двигателем — это замедление, которое возникает, когда во время движения вы отпускаете педаль акселератора. Чем ниже передача, тем сильнее эффект торможения двигателем.
