...
| Раздел | Страница |
| --- | --- |
| Подготовка перед выездом: проверка автомобиля | 2-2 |
| Если перевозите багаж | 2-5 |
| Если перевозите детей | 2-6 |
| Для пользователей имплантированных кардиостимуляторов и других медицинских устройств | 2-13 |
| Правильная посадка на водительском месте | 2-14 |
| Во время движения | 2-19 |
| Во время стоянки | 2-27 |
| При заправке | 2-30 |
| Если управляете автомобилем с автоматической коробкой передач | 2-32 |
| Если автомобиль оснащён подушками безопасности SRS | 2-34 |
| Если управляете автомобилем 4WD | 2-37 |
| Если управляете автомобилем с турбонаддувом | 2-40 |
| Другие меры предосторожности | 2-41 |
| Экологичное вождение | 2-46 |
...
!!! danger "Внимание"
    ...
    См. также: [4-64: если корректная скорость вращения шин не определяется](04-driving.md#4-64-если-корректная-скорость-вращения-шин-не-определяется).
...
### Проверяйте уровень жидкости свинцово-кислотного аккумулятора
...
![Уровень жидкости свинцово-кислотного аккумулятора](images/02-safety/69TJ052070.png){ .center-image }
...
!!! info "Примечание"
    ...
    Автомобили с системой автоматической остановки двигателя на холостом ходу оснащены специальным высокопроизводительным свинцово-кислотным аккумулятором. Соблюдайте следующие правила, иначе система может перестать работать нормально или срок службы аккумулятора может сократиться:
    ...
    См. также: [8-1: сервисные данные](08-service-data.md#8-1-сервисные-данные).
...
!!! danger "Внимание"
    ...
    - при срабатывании боковой или шторочной подушки безопасности SRS сильный удар также может привести к тяжёлым травмам. Следите, чтобы ребёнок не высовывался из окна и не прислонялся к двери;
...
См. также: [3-59: детские удерживающие устройства](03-before-driving.md#3-59-детские-удерживающие-устройства).
...
!!! danger "Внимание"
    ...
    При срабатывании боковой или шторочной подушки безопасности SRS ребёнок может получить тяжёлые травмы. Следите, чтобы ребёнок не высовывал руки из окна и не прислонялся к двери.
...
- [3-28: регулировка рулевой колонки](03-before-driving.md#3-28-регулировка-рулевой-колонки);
- [3-29: передние сиденья](03-before-driving.md#3-29-передние-сиденья);
- [3-23: внутреннее зеркало и дверные зеркала](03-before-driving.md#3-23-внутреннее-зеркало-и-дверные-зеркала).
...
См. также: [2-14: правильная посадка](#сохраняйте-правильную-посадку).
...
См. также: [2-46: экологичное вождение](#экологичное-вождение).
...
!!! tip "Оборудование по типу автомобиля"
    Для автомобиля с механической коробкой передач понижайте передачу на одну ступень за раз. Для автомобиля с автоматической коробкой передач выключите овердрайв `O/D` или переведите селектор в положение `2` либо `L`.

См. также: [4-28: рычаг переключения передач](04-driving.md#4-28-рычаг-переключения-передач) и [4-30: селектор передач](04-driving.md#4-30-селектор-передач).
...
!!! info "Примечание"
    ...
    При движении по затопленному месту система автоматической остановки двигателя на холостом ходу может повредить двигатель. Отключите систему перед таким движением.

См. также: [4-17: система автоматической остановки двигателя на холостом ходу](04-driving.md#4-17-система-автоматической-остановки-двигателя-на-холостом-ходу) и [7-9: если автомобиль был затоплен](07-emergency.md#7-9-если-автомобиль-был-затоплен).
...
См. также: [4-42: переключение 2WD/4WD](04-driving.md#4-42-переключение-2wd4wd).
...
!!! tip "Подсказка"
    ...
    - на автомобиле с автоматической коробкой передач перед переключением селектора слегка нажмите педаль акселератора;
...
См. также: [4-42: переключение 2WD/4WD](04-driving.md#4-42-переключение-2wd4wd) и [4-48: ESP®](04-driving.md#4-48-esp).
...
См. также: [1-17: предупреждающие лампы](01-quick-guide.md#1-17-предупреждающие-лампы) и [3-114: сообщения многофункционального дисплея](03-before-driving.md#3-114-сообщения-многофункционального-дисплея).
...
См. также: [7-18: прокол колеса](07-emergency.md#7-18-прокол-колеса).
...
1. Удерживая педаль тормоза нажатой, надёжно включите стояночный тормоз.
    ...
    См. также: [4-27: стояночный тормоз](04-driving.md#4-27-стояночный-тормоз).
...
!!! warning "Осторожно"
    ...
    См. также: [6-21: стояночный тормоз](06-care.md#6-21-стояночный-тормоз).
...
См. также: [5-2: лючок топливного бака](05-equipment.md#5-2-лючок-топливного-бака).
...
См. также: [4-30: автомобиль с автоматической коробкой передач](04-driving.md#4-30-автомобиль-с-автоматической-коробкой-передач).
...
Чтобы система подушек безопасности SRS могла работать эффективно, прочитайте также раздел [3-46: подушки безопасности SRS](03-before-driving.md#3-46-srs-airbag) и соблюдайте правила эксплуатации.
...
Водитель, пассажир переднего сиденья и пассажиры заднего сиденья должны сидеть глубоко в сиденье и слегка прижимать спину к спинке. Не выдвигайте сиденье слишком далеко вперёд.
...
!!! danger "Внимание"
    ...
    При срабатывании боковой или шторочной подушки безопасности SRS сильный удар может привести к тяжёлым травмам. Не высовывайте руки из окна, не прислоняйтесь к двери. Пассажирам заднего сиденья не следует обхватывать спинку переднего сиденья.
...
!!! danger "Внимание"
    ...
    При срабатывании боковой или шторочной подушки безопасности SRS предметы могут отлететь или помешать нормальному раскрытию, что может привести к тяжёлым травмам. Не устанавливайте держатели стаканов, крючки, вешалки и другие аксессуары рядом с дверями и не ставьте зонты в этой зоне.
...
| Символ руководства | Прочитайте это руководство. См. [2-8: использование детского удерживающего устройства](#использование-детских-удерживающих-устройств) и [3-59: выбор детского удерживающего устройства](03-before-driving.md#3-59-выбор-детского-удерживающего-устройства). |
...
!!! warning "Осторожно"
    4WD улучшает движение по снегу, крутым подъёмам, песку, грязи и другим покрытиям, где шины легко буксуют, но не делает автомобиль всепроходимым. Это не внедорожный спортивный или раллийный автомобиль.
...
!!! tip "Подсказка"
    ...
    См. также: [6-2: уход за кузовом](06-care.md#6-2-уход-за-кузовом).
...
- регулярно заменяйте моторное масло и масляный фильтр. Если продолжать ездить со старым маслом, смазка и охлаждение турбонагнетателя ухудшатся, и вал турбины может заклинить;

См. также: [2-44: замена моторного масла](#замена-моторного-масла).
...
См. также: [4-51: выключатель отключения ESP®](04-driving.md#4-51-выключатель-esp-off).

- противобуксовочная система и система стабилизации;
- системы помощи водителю Suzuki Safety Support.

См. также: [4-62: системы помощи водителю Suzuki Safety Support](04-driving.md#4-62-suzuki-safety-support).
...
!!! danger "Внимание"
    ...
    - установка аудиооборудования и других аксессуаров;
...
- API - спецификация American Petroleum Institute, которая обозначает класс качества моторного масла.
- ILSAC - спецификация International Lubricant Specification Advisory Committee для автомобильных моторных масел. Она основана на спецификации API и указывает, что масло также имеет улучшенные характеристики по расходу топлива, долговечности и другим параметрам.
- SAE - спецификация вязкости моторного масла. Число слева от `W` обозначает вязкость при низкой температуре: чем оно меньше, тем лучше пуск двигателя в холодную погоду. Число справа обозначает вязкость при высокой температуре: чем оно больше, тем выше стойкость масла к нагреву и защитные свойства.
