...
- В следующих случаях возможны коррозия и изменение цвета лакокрасочного покрытия. Как можно скорее вымойте автомобиль:
    ...
    - если на кузов попали птичий помёт, остатки насекомых, древесная смола, металлическая пыль, сажа, каменноугольная смола или кислотный дождь;
...
!!! info "Примечание"
    Для ремонта повреждений лакокрасочного покрытия обратитесь к дилеру Suzuki или в авторизованный сервис Suzuki. При использовании неподходящей краски покрытие может отслоиться.
...
!!! warning "Осторожно"
    Если автоматическая мойка не требует положения селектора `P` или полной остановки автомобиля, например в мойке конвейерного типа, отключите систему помощи при торможении на малой скорости при движении вперёд и назад с помощью [выключателя `OFF` системы поддержки торможения с двумя датчиками DSBS II](04-driving.md#выключатель-off-системы-поддержки-торможения-с-двумя-датчиками-dsbs-ii).

    Иначе система помощи при торможении на малой скорости при движении вперёд и назад может неожиданно сработать и привести к аварии.
...
!!! danger "Внимание"
    Если вода попадёт на аудиосистему, переключатели, проводку и электрические компоненты под напольным покрытием, это может привести к пожару, неисправности или нарушению работы системы подушек безопасности SRS.

    При уходе за салоном не лейте воду внутрь автомобиля. Если вода попала в салон или в салоне пролили напиток, как можно скорее обратитесь к дилеру Suzuki или в авторизованный сервис Suzuki для проверки.
...
!!! info "Примечание"
    ...
    - бензин, растворитель, средство для удаления наклеек и подобные вещества;
...
<a id="уход-за-внутренней-стороной-стекла-задней-двери"></a>

#### Уход за внутренней стороной стекла двери багажного отделения
...
!!! tip "Подсказка"
    - При замене элемента питания можно повредить пульт. Рекомендуется обратиться для платной замены к дилеру Suzuki или в авторизованный сервис Suzuki.
...
!!! info "Примечание"
    - Рекомендуется использовать оригинальные щётки и резинки щёток стеклоочистителей Suzuki.
...
!!! tip "Подсказка"
    Проверку концентрации и замену охлаждающей жидкости поручайте дилеру Suzuki или авторизованному сервису Suzuki.

#### Зимние щётки стеклоочистителей (приобретаются отдельно) {#зимние-щётки-стеклоочистителей}
...
Используйте оригинальные цепи противоскольжения Suzuki, подходящие для этого автомобиля. Чтобы подобрать подходящие цепи, обратитесь к дилеру Suzuki или в авторизованный сервис Suzuki.
