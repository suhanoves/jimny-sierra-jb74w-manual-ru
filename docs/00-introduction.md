...
## По вопросам и консультациям

Если у вас есть вопросы об автомобиле, техосмотре, проверке или послепродажном обслуживании, сначала обратитесь к дилеру Suzuki или представителю Suzuki, у которого приобретён автомобиль.

![Консультация у дилера Suzuki](images/00-introduction/page-00-514.png){ .center-image }

Если обращаетесь к представителю Suzuki за консультацией или обслуживанием, подготовьте сервисную книжку «Suzuki 4-wheel service network» и свяжитесь с ближайшим представителем Suzuki.

Чтобы обращение обработали быстрее, заранее подготовьте следующие данные:

1. модель автомобиля, номер шасси и регистрационный номер;
2. дату покупки;
3. пробег;
4. содержание обращения;
5. адрес, имя и номер телефона владельца.
