...
- Частые вопросы: [1-33](01-quick-guide.md)
...
EDR — сокращение от английского Event Data Recorder, то есть регистратор событий. Он записывает данные при авариях, в которых срабатывает система подушек безопасности SRS.
