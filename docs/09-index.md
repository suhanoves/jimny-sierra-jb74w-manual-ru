...
| Термин | Страницы |
| --- | --- |
| [Уровень электролита аккумуляторной батареи](02-safety.md#проверяйте-уровень-жидкости-свинцово-кислотного-аккумулятора) | 2-4 |
...
![Обращение к представителю Suzuki](images/09-index/page-09-h2-3.png){ .center-image }
