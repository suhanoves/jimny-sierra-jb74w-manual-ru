...
| Группа | Пункт | Возможные настройки |
| --- | --- | --- |
| Настройки DSBS II | Момент предупреждения | Рано / стандартно / поздно |
| Настройки DSBS II | Помощь на малой скорости | `ON` / `OFF` |
| Настройки предотвращения схода с полосы | Способ предупреждения | Вибрация / зуммер |
| Настройки предотвращения схода с полосы | Момент предупреждения | Рано / стандартно |
| Настройки предотвращения схода с полосы | Предупреждение о вилянии | `ON` / `OFF` |
| Настройки адаптивного круиз-контроля | Ускорение | Слабое / среднее / сильное |
| Настройки адаптивного круиз-контроля | Изменение скорости коротким нажатием | 1 км/ч / 5 км/ч / 10 км/ч |
| Настройки адаптивного круиз-контроля | Изменение скорости удержанием | 1 км/ч / 5 км/ч / 10 км/ч |
| Настройки адаптивного круиз-контроля | Ограничение скорости в повороте | `OFF` / слабое / среднее / сильное |
| Настройки распознавания дорожных знаков | Распознавание знаков | `ON` / `OFF` |
| Настройки распознавания дорожных знаков | Способ предупреждения о превышении скорости по знаку | Без предупреждения / индикация / индикация и зуммер |
| Настройки распознавания дорожных знаков | Способ предупреждения по другим знакам | Без предупреждения / индикация / индикация и зуммер |
| Настройки распознавания дорожных знаков | Порог предупреждения о превышении скорости | +2 км/ч / +5 км/ч / +10 км/ч |
| Настройки уведомления о начале движения | Автомобиль впереди | `ON` / `OFF` |
| Настройки уведомления о начале движения | Светофор | `ON` / `OFF` |
| Настройки уведомления о начале движения | Момент уведомления | Рано / стандартно / поздно |
| Настройки замков дверей | Наружный зуммер | `ON` / `OFF` |
| Настройки освещения | Система автоматического дальнего света | `ON` / `OFF` |
| Настройки климатической системы при автоматической остановке двигателя | Режим работы | Стандартно / приоритет расхода топлива / приоритет комфорта |
| Способ сброса среднего расхода топлива | Вариант сброса | При заправке / вместе с `TRIP A` / не связывать |
| Настройки часов, автомобили без дисплея аудиосистемы | Настройка времени | См. [настройку времени](03-before-driving.md#настройка-времени) |
| Настройки часов, автомобили без дисплея аудиосистемы | Формат 12/24 ч | 12 ч / 24 ч |
| Настройки часов, автомобили без дисплея аудиосистемы | Настройка даты | См. [настройку даты](03-before-driving.md#настройка-даты) |
| Настройки часов, автомобили без дисплея аудиосистемы | Отображение часов | Календарь включён / календарь выключен |
| Настройки часов, автомобили без дисплея аудиосистемы | Формат календаря | `DD.MM.YYYY` / `YYYY.MM.DD` / `MM.DD.YYYY` |
| Отображение на дисплее | История расхода топлива | По времени / по поездкам |
| Отображение на дисплее | История движения | Показывать / не показывать |
| Отображение на дисплее | Время автоматической остановки двигателя и сэкономленное топливо | Показывать / не показывать |
| Основной экран | Расход топлива | Показывать / не показывать |
| Основной экран | История расхода топлива | Показывать / не показывать |
| Основной экран | Средняя скорость / время движения | Показывать / не показывать |
| Основной экран | Суммарное время автоматической остановки двигателя / сэкономленное топливо | Показывать / не показывать |
| Основной экран | Часы | Показывать / не показывать |
| Основной экран | Движение | Показывать / не показывать |
| Основной экран | Мощность / крутящий момент | Показывать / не показывать |
| Основной экран | Педаль акселератора / тормоза | Показывать / не показывать |
| Основной экран | Скорость автомобиля | Показывать / не показывать |
| Анимация на дисплее | Подсказки проезда перекрёстков | Показывать поверх текущего экрана / не показывать поверх текущего экрана / не показывать |
| Анимация на дисплее | Предупреждения | Показывать / не показывать |
| Звук при запуске | Воспроизведение звука | `ON` / `OFF` |
| Звуки уведомлений | Громкость | Громко / средне / тихо |
| Голосовые подсказки | Голосовые уведомления | Громко / средне / тихо / `OFF` |
| Голосовые подсказки | Голосовые подсказки систем помощи водителю | Громко / средне / тихо / `OFF` |
| Возврат к заводским настройкам | Сброс настроек | Да / Нет |
