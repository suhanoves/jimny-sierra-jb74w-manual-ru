...
Закрывая дверь багажного отделения, слегка подтолкните её рукой снаружи, чтобы она надёжно закрылась.
...
- Если в противоугонной системе автомобиля есть неисправность, при режиме питания `ON` индикатор мигает с интервалом 1 секунда. Обратитесь к дилеру Suzuki или в авторизованный сервис Suzuki для проверки автомобиля.
...
!!! danger "Внимание"
    Сработавшие преднатяжители и подушки безопасности нельзя использовать повторно. Обратитесь к дилеру Suzuki или в авторизованный сервис Suzuki для замены.
...
!!! warning "Осторожно"
    Перед утилизацией подушек безопасности или списанием автомобиля, оборудованного подушками безопасности, обратитесь к дилеру Suzuki или в авторизованный сервис Suzuki. При неправильном обращении подушки безопасности могут неожиданно раскрыться и причинить травму.
...
!!! info "Примечание"
    <span id="coolant-temperature-warning-note"></span>※
...
| ![Проверьте систему запуска](images/03-before-driving/69T040170.png)<br>«Проверьте систему запуска» | Мигает | Зуммер в салоне: одиночный сигнал | Возможна неисправность иммобилайзера или системы бесключевого запуска кнопкой, либо низкое напряжение свинцово-кислотной аккумуляторной батареи. Если сообщение отображается при нормальном напряжении батареи, обратитесь для проверки к дилеру Suzuki или в авторизованный сервис Suzuki.<br>См. также: [иммобилайзер](04-driving.md#система-иммобилайзера), [система бесключевого запуска кнопкой](04-driving.md#система-бесключевого-запуска-кнопкой). |
| ![Замените элемент питания пульта](images/03-before-driving/69T040210.png)<br>«Замените элемент питания пульта» ([※2](#multi-info-message-on-note-2)) | Не горит | Зуммер в салоне: одиночный сигнал; также голосовая подсказка | Элемент питания пульта дистанционного управления почти разряжен. Замените элемент питания.<br>См. также: [замена элемента питания пульта](06-care.md#замена-элемента-питания-пульта-дистанционного-управления). |
...
| ![Проверьте систему GPF](images/03-before-driving/69T040270.png)<br>«Проверьте систему GPF» | Мигает | Зуммер в салоне: одиночный сигнал | Возможна неисправность бензинового сажевого фильтра GPF. Обратитесь для проверки к дилеру Suzuki или в авторизованный сервис Suzuki.<br>GPF: бензиновый сажевый фильтр. |
...
<span id="multi-info-message-on-note-2"></span>※2 Отображение этого сообщения можно изменить в режиме настроек. См. также: [режим настроек](08-service-data.md#режим-настроек).
