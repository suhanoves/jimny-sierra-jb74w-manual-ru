...
См. также: [система поддержки торможения с двумя датчиками DSBS II](04-driving.md#система-поддержки-торможения-с-двумя-датчиками-dsbs-ii), [предотвращение ошибочного начала движения](04-driving.md#предотвращение-ошибочного-начала-движения), [поддержка торможения на малой скорости](04-driving.md#поддержка-торможения-на-малой-скорости-при-движении-вперёд-и-назад), [предотвращение ошибочного начала движения назад](04-driving.md#предотвращение-ошибочного-начала-движения-назад).
...
См. также: [предупреждение о сходе с полосы](04-driving.md#предупреждение-о-сходе-с-полосы), [предотвращение схода с полосы](04-driving.md#предотвращение-схода-с-полосы), [предупреждение о вилянии автомобиля](04-driving.md#предупреждение-о-вилянии).
...
См. также: [выключатель отключения предотвращения схода с полосы](04-driving.md#выключатель-off-предотвращения-схода-с-полосы).
...
См. также: [адаптивный круиз-контроль](04-driving.md#адаптивный-круиз-контроль), [адаптивный круиз-контроль с функцией следования до полной остановки](04-driving.md#адаптивный-круиз-контроль-с-функцией-следования-во-всём-диапазоне-скоростей).
...
| ![Состояние питания ACC](images/03-before-driving/69T040140-acc.png)<br>«Состояние питания: ACC», см. примечание 1 | Не горит | Нет | Отображается, когда питание находится в режиме `ACC`.<br>См. также: [переключение режима питания](04-driving.md#переключение-питания). |
...
| ![Проверьте систему запуска](images/03-before-driving/69T040170.png)<br>«Проверьте систему запуска» | Мигает | Внутренний зуммер: одиночный сигнал | Возможна неисправность иммобилайзера или системы запуска без ключа, либо низкое напряжение свинцово-кислотной аккумуляторной батареи. Если сообщение отображается при нормальном напряжении батареи, обратитесь для проверки к дилеру Suzuki или представителю Suzuki.<br>См. также: [иммобилайзер](04-driving.md#система-иммобилайзера), [система запуска без ключа](04-driving.md#система-бесключевого-запуска-кнопкой). |
...
| ![Поднесите пульт к выключателю двигателя](images/03-before-driving/69T040190.png)<br>«Поднесите пульт к выключателю двигателя»<br><br>![Пульт не обнаружен](images/03-before-driving/69T040180.png)<br>«Пульт не обнаружен» | Мигает | Сначала внутренний и наружный зуммер: прерывистый сигнал; затем внутренний зуммер: одиночный сигнал | Когда выключатель двигателя был переведён в положение `ACC` или `ON`, пульт обнаруживался, но при запуске перестал обнаруживаться. Разместите пульт в зоне обнаружения в салоне и управляйте выключателем двигателя.<br>См. также: [рабочая зона в салоне](03-before-driving.md#зона-обнаружения-пульта-в-салоне), [запуск двигателя](04-driving.md#запуск-двигателя). |
...
| ![Состояние питания ON](images/03-before-driving/69T040140-on.png)<br>«Состояние питания: ON», см. примечание 1 | Не горит | Нет | Отображается, когда питание находится в режиме `ON`.<br>См. также: [переключение режима питания](04-driving.md#переключение-питания). |
...
| ![Нажмите тормоз и сцепление](images/03-before-driving/69TJ040670.png)<br>«Нажмите тормоз и сцепление» | Не горит | Внутренний зуммер: одиночный сигнал | Выключатель двигателя нажат без нажатия педали тормоза и педали сцепления. Следуйте указанию сообщения.<br>См. также: [запуск двигателя](04-driving.md#запуск-двигателя). |
| ![Проверьте блокировку рулевого колеса](images/03-before-driving/69T040160.png)<br>«Проверьте блокировку рулевого колеса» | Мигает | Внутренний зуммер: одиночный сигнал | Возможна неисправность блокировки рулевого колеса. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.<br>См. также: [возврат выключателя двигателя](04-driving.md#когда-переводите-выключатель-двигателя-в-lock). |
| ![Поверните рулевое колесо и нажмите выключатель двигателя](images/03-before-driving/84S304190.png)<br>«Поворачивая рулевое колесо вправо-влево, нажмите выключатель двигателя», см. примечание 1 | Мигает | Внутренний зуммер: одиночный сигнал; также голосовая подсказка | Блокировка рулевого колеса не снята. Поворачивая рулевое колесо вправо-влево, повторите операцию с выключателем двигателя.<br>См. также: [если блокировка рулевого колеса не снимается](04-driving.md#если-блокировка-рулевой-колонки-не-снимается). |
| ![Проверьте систему запуска](images/03-before-driving/69T040170.png)<br>«Проверьте систему запуска» | Мигает | Внутренний зуммер: одиночный сигнал | Возможна неисправность иммобилайзера или системы запуска без ключа, либо низкое напряжение свинцово-кислотной аккумуляторной батареи. Если сообщение отображается при нормальном напряжении батареи, обратитесь для проверки к дилеру Suzuki или представителю Suzuki.<br>См. также: [иммобилайзер](04-driving.md#система-иммобилайзера), [система запуска без ключа](04-driving.md#система-бесключевого-запуска-кнопкой). |
| ![Замените элемент питания пульта](images/03-before-driving/69T040210.png)<br>«Замените элемент питания пульта», см. примечание 2 | Не горит | Внутренний зуммер: одиночный сигнал; также голосовая подсказка | Элемент питания пульта дистанционного управления почти разряжен. Замените элемент питания.<br>См. также: [замена элемента питания пульта](06-care.md#замена-элемента-питания-пульта-дистанционного-управления). |
| ![Пульт не обнаружен](images/03-before-driving/69T040180.png)<br>«Пульт не обнаружен»<br><br>![Поднесите пульт к выключателю двигателя](images/03-before-driving/69T040190.png)<br>«Поднесите пульт к выключателю двигателя» | Мигает | Внутренний и наружный зуммер: короткий прерывистый сигнал; также голосовая подсказка<br>или<br>внутренний зуммер: одиночный сигнал; также голосовая подсказка | Пульт дистанционного управления не находится в салоне или его элемент питания разряжен. Верните пульт в салон или приложите пульт к выключателю двигателя.<br>См. также: [предупреждение о выносе пульта из автомобиля](04-driving.md#предупреждение-о-выносе-пульта-дистанционного-управления-из-автомобиля), [запуск двигателя](04-driving.md#запуск-двигателя). |
...
| ![Проверьте систему ESP](images/03-before-driving/77R31540.png)<br>«Проверьте систему ESP» | Мигает | Внутренний зуммер: одиночный сигнал | Возможна неисправность системы ESP. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.<br>См. также: [система ESP](04-driving.md#esp). |
...
| ![Впереди стоящий автомобиль тронулся](images/03-before-driving/84S304300.png)<br>«Впереди стоящий автомобиль тронулся»<br><br>![Сигнал светофора изменился](images/03-before-driving/84S304250.png)<br>«Сигнал светофора изменился» | Не горит | Внутренний зуммер: короткий прерывистый сигнал | Работает функция напоминания о начале движения.<br>См. также: [напоминание о начале движения](04-driving.md#уведомление-о-начале-движения). |
| «Система поддержки торможения с двумя датчиками DSBS II выключена» | Мигает | Внутренний зуммер: одиночный сигнал | Система поддержки торможения с двумя датчиками DSBS II, функция предотвращения ошибочного начала движения, поддержка торможения на малой скорости при движении вперёд и назад и функция предотвращения ошибочного начала движения назад остановлены.<br>См. также: [выключатель отключения системы поддержки торможения с двумя датчиками DSBS II](04-driving.md#выключатель-off-системы-поддержки-торможения-с-двумя-датчиками-dsbs-ii). |
...
| ![Система поддержки торможения с двумя датчиками DSBS II](images/03-before-driving/69TJ040530.png)<br>«Система поддержки торможения с двумя датчиками DSBS II» | Мигает | Внутренний зуммер: короткий прерывистый сигнал | Работает предупреждение о фронтальном столкновении, помощь при торможении для уменьшения ущерба при фронтальном столкновении или торможение для уменьшения ущерба при столкновении.<br>См. также: [предупреждение о фронтальном столкновении](04-driving.md#предупреждение-о-фронтальном-столкновении), [помощь при торможении для уменьшения ущерба при фронтальном столкновении](04-driving.md#помощь-при-торможении-для-снижения-последствий-фронтального-столкновения), [торможение для уменьшения ущерба при столкновении](04-driving.md#торможение-для-снижения-последствий-столкновения). |
| ![Поддержка торможения на малой скорости вперёд](images/03-before-driving/69TJ040530.png) | Не горит | Внутренний зуммер: короткий прерывистый сигнал | Работает поддержка торможения при движении вперёд на малой скорости.<br>См. также: [поддержка торможения на малой скорости](04-driving.md#поддержка-торможения-на-малой-скорости-при-движении-вперёд-и-назад). |
| ![Поддержка торможения на малой скорости назад](images/03-before-driving/69TJ040540.png) | Не горит | Внутренний зуммер: короткий прерывистый сигнал | Работает поддержка торможения при движении назад на малой скорости.<br>См. также: [поддержка торможения на малой скорости](04-driving.md#поддержка-торможения-на-малой-скорости-при-движении-вперёд-и-назад). |
| ![Проверьте систему парковочных датчиков](images/03-before-driving/84S304310.png)<br>«Проверьте систему парковочных датчиков» | Мигает | Внутренний зуммер: одиночный сигнал | Возможна неисправность ультразвуковых датчиков. Если после перезапуска двигателя сообщение отображается снова, обратитесь к дилеру Suzuki или представителю Suzuki.<br>См. также: [временная остановка и неисправность передней камеры, переднего радара и ультразвуковых датчиков](04-driving.md#временная-остановка-или-неисправность-передней-камеры-переднего-радара-и-ультразвуковых-датчиков). |
