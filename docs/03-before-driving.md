...
| Использование переключателей | [Выключатель аварийной сигнализации](#выключатель-аварийной-сигнализации) | 3-136 |
...
См. также: [иммобилайзер](04-driving.md#иммобилайзер).
...
!!! info "Примечание"
    ...
    См. также: [замок зажигания](04-driving.md#замок-зажигания).
...
!!! tip "Подсказка"
    ...
    См. также: [замена батарейки ключа с дистанционным управлением](06-care.md#замена-батарейки-ключа-с-дистанционным-управлением).
...
См. также: [салонное освещение](05-equipment.md#салонное-освещение).
...
!!! tip "Подсказка"
    ...
    См. также: [вещевые отделения панели приборов](05-equipment.md#вещевые-отделения-панели-приборов).
    См. также: [подстаканник и держатель бутылки](05-equipment.md#подстаканник-и-держатель-бутылки).
    См. также: [прочее оборудование](05-equipment.md#прочее-оборудование).
...
См. также: [задние сиденья](#задние-сиденья).
...
1. Закрепите ремни безопасности задних сидений в держателях.
    ...
    См. также: [закрепление заднего ремня безопасности в держателе](#закрепление-заднего-ремня-безопасности-в-держателе).
...
!!! danger "Внимание"
    Сработавшие преднатяжители и подушки безопасности нельзя использовать повторно. Обратитесь к дилеру Suzuki или представителю Suzuki для замены.
...
!!! danger "Внимание"
    ...
    Если воздействовать на детали, влияющие на работу подушек безопасности SRS, система может сработать случайно или не сработать тогда, когда это необходимо. В следующих случаях возможное вмешательство может повлиять на работу системы. Заранее проконсультируйтесь с дилером Suzuki или представителем Suzuki:
...
!!! danger "Внимание"
    ...
    - не ставьте ребёнка перед местом установки подушки безопасности SRS и не держите ребёнка на коленях. Перевозите детей на заднем сиденье и пристегивайте их ремнём безопасности.
...
!!! warning "Осторожно"
    ...
    Если остатки газа попали в глаза или на кожу, как можно скорее смойте их водой. У людей с чувствительной кожей возможно раздражение.
...
Подушки безопасности, которые не сработали, перед утилизацией необходимо активировать в установленном порядке.

![Утилизация подушек безопасности SRS](images/03-before-driving/80J112.png){ .center-image }

!!! warning "Осторожно"
    Перед утилизацией подушек безопасности или списанием автомобиля, оборудованного подушками безопасности, обратитесь к дилеру Suzuki или представителю Suzuki. При неправильном обращении подушки безопасности могут неожиданно раскрыться и причинить травму.
...
На детских удерживающих устройствах, соответствующих стандартам UN R44 и UN R129, указывается сертификационная маркировка примерно такого вида:
...
| --- | --- |
| (1) | Номер нормативного документа. |
| (2) | Категория детского удерживающего устройства. |
...
UN R44 и UN R129: международные нормативы для детских удерживающих устройств.

На самой маркировке может быть указано `ECE`, но по содержанию это соответствует `UN`.

Надпись `Universal` означает одобрение универсальной категории.
...
Это детское удерживающее устройство, которое устанавливается против хода движения или боком. Оно предназначено для детей, которые ещё не держат голову или не могут сидеть самостоятельно.

![Детская люлька](images/03-before-driving/64L30810.png){ .center-image }
...
| --- | --- | --- |
| 1 | ![Символ универсального детского удерживающего устройства](images/03-before-driving/page-03-62-mark-universal.png){ width="44" } ![Символ запрета устройства против хода движения](images/03-before-driving/page-03-62-mark-no-rear-facing.png){ width="44" } | [Прим. 1](#child-seat-position-note-1), [прим. 2](#child-seat-position-note-2), [прим. 3](#child-seat-position-note-3). |
| 2 | ![Символ универсального детского удерживающего устройства](images/03-before-driving/page-03-62-mark-universal.png){ width="44" } ![Символ i-Size и ISOFIX](images/03-before-driving/page-03-62-mark-isize.png){ width="44" } ![Символ верхнего страховочного анкера](images/03-before-driving/page-03-62-mark-tether.png){ width="44" } | [Прим. 2](#child-seat-position-note-2), [прим. 3](#child-seat-position-note-3). |
...
| ![Символ запрета устройства против хода движения](images/03-before-driving/page-03-62-mark-no-rear-facing.png){ width="48" } | На сиденье, защищённом активной фронтальной подушкой безопасности, запрещено использовать детскую люльку и другие детские удерживающие устройства, устанавливаемые против хода движения. |

Примечания:

<a id="child-seat-position-note-1"></a>
**Примечание 1.** Если детское удерживающее устройство всё же приходится установить на переднее пассажирское сиденье, сдвиньте сиденье в самое заднее положение.

<a id="child-seat-position-note-2"></a>
**Примечание 2.** При установке детского удерживающего устройства по ходу движения отрегулируйте угол наклона спинки так, чтобы между детским удерживающим устройством и спинкой было как можно меньше зазора. Если угол спинки на автомобиле не регулируется и между устройством и спинкой остаётся зазор, заполните его, например, подушкой.

<a id="child-seat-position-note-3"></a>
**Примечание 3.** Если подголовник мешает детскому удерживающему устройству, отрегулируйте высоту подголовника так, чтобы он не касался устройства, или снимите подголовник.

##### Подробная пригодность по местам

| Параметр | Место 1 | Место 2 | Место 3 |
| --- | --- | --- | --- |
| Подходит для универсального детского удерживающего устройства, закрепляемого ремнём безопасности | Да, только по ходу движения ([прим. 1](#child-seat-detail-note-1)) | Да | Да |
| Подходит для детского удерживающего устройства i-Size | Нет | Да | Да |
| Подходит для боковой детской люльки, шаблон `L1`/`L2` | Нет | `X` | `X` |
| Подходит для устройства против хода движения, шаблон `R1`/`R2X`/`R2`/`R3` | Нет | `R1`, `R2` ([прим. 2](#child-seat-detail-note-2)) | `R1`, `R2` ([прим. 2](#child-seat-detail-note-2)) |
| Подходит для устройства по ходу движения, шаблон `F2X`/`F2`/`F3` | Нет | `F2X`, `F2`, `F3` ([прим. 2](#child-seat-detail-note-2)) | `F2X`, `F2`, `F3` ([прим. 2](#child-seat-detail-note-2)) |
| Подходит для бустера, шаблон `B2`/`B3` | `B2`, `B3` | `B2`, `B3` | `B2`, `B3` |

<a id="child-seat-detail-note-1"></a>
**Примечание 1.** На переднее пассажирское сиденье можно устанавливать только детское удерживающее устройство по ходу движения.

<a id="child-seat-detail-note-2"></a>
**Примечание 2.** Для мест 2 и 3 при использовании шаблонов `R1`, `R2`, `F2X`, `F2` и `F3` поднимите подголовник в самое высокое положение.
...
| --- | --- | --- | --- |
| 0, до 10 кг | `F` | `L1` | Детское удерживающее устройство для положения боком влево, люлька. |
| 0, до 10 кг | `G` | `L2` | Детское удерживающее устройство для положения боком вправо, люлька. |
...
Люлька - это один из видов детского удерживающего устройства, которое позволяет перевозить ребёнка лёжа и устанавливается боком. Подробности уточняйте у изготовителя или продавца детского удерживающего устройства.
...
Для автомобиля рекомендуется использовать оригинальные детские удерживающие устройства Suzuki. Подробности уточняйте у дилера Suzuki или представителя Suzuki.
...
Задние сиденья, левое и правое, оснащены креплениями для детских удерживающих устройств ISOFIX или i-Size, соответствующих стандартам UN R44 или UN R129. Детские удерживающие устройства приобретаются отдельно.
...
**Примечание 1.** ISOFIX: международный стандарт ISO, который унифицирует размеры и способы крепления детских удерживающих устройств.

<a id="isofix-note-2"></a>
**Примечание 2.** i-Size: стандарт безопасности для детских удерживающих устройств, рассчитанный на использование ISOFIX. Такие устройства имеют конструкцию, которая надёжно защищает голову и шею ребёнка. Группы определяются не по массе, как раньше, а по росту ребёнка.

<a id="isofix-note-3"></a>
**Примечание 3.** ISO: Международная организация по стандартизации.
...
!!! danger "Внимание"
    ...
    Не используйте анкеры ISOFIX и верхние страховочные анкеры для крепления багажа. Анкеры могут погнуться или повредиться, и детское удерживающее устройство не будет закрепляться как положено.
...
!!! danger "Внимание"
    ...
    При установке детского удерживающего устройства поднимите подголовник в самое высокое фиксируемое положение или снимите его.
...
!!! info "Примечание"
    Чтобы защитить двигатель, не допускайте захода стрелки в красную зону. Красная зона показывает диапазон, превышающий допустимые обороты двигателя.
...
Когда питание автомобиля находится в режиме `ON`, поверните рукоятку переключателя освещения в положение фар, габаритных огней или `AUTO`. После этого поверните ручку переключения индикации (1) справа от комбинации приборов влево или вправо, чтобы открыть экран регулировки яркости.

![Ручка переключения индикации для регулировки яркости](images/03-before-driving/77R30570.png){ .center-image }

Поверните ручку переключения индикации влево или вправо и установите нужную яркость. Яркость приборов регулируется по 7 уровням.
...
!!! danger "Внимание"
    Не переключайте индикацию во время движения. Можно отвлечься от управления, что может привести к неожиданной аварии.

!!! tip "Подсказка"
    Если во время регулировки некоторое время не выполнять действий, экран вернётся к прежней индикации.
...
Информационный переключатель (1) используется для переключения индикации комбинации приборов.

- Им можно пользоваться на стоящем автомобиле, когда питание находится в режиме `ON`.

![Информационный переключатель и ручка переключения индикации](images/03-before-driving/77R30580.png){ .center-image }
...
!!! danger "Внимание"
    В следующих случаях немедленно остановитесь в безопасном месте и обратитесь к дилеру Suzuki или представителю Suzuki:
    ...
    См. также: [предупреждающий зуммер неотпущенного стояночного тормоза](04-driving.md#предупреждающий-зуммер-неотпущенного-стояночного-тормоза).
...
- Если после пристёгивания ремня лампа продолжает гореть или мигать, возможна неисправность системы. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.
...
!!! tip "Подсказка"
    ...
    Если на сиденье переднего пассажира лежит багаж, датчик может определить его массу, и лампа начнёт мигать, а предупреждающий зуммер - звучать даже без пассажира.
...
!!! tip "Подсказка"
    ...
    Если на заднем сиденье лежит багаж, датчик может определить его массу, и лампа начнёт мигать, а предупреждающий зуммер - звучать даже без пассажира.
...
!!! danger "Внимание"
    В следующих случаях немедленно прекратите эксплуатацию автомобиля и обратитесь к дилеру Suzuki или представителю Suzuki. При столкновении подушки безопасности SRS или преднатяжители ремней безопасности могут не сработать нормально, что может привести к тяжёлым травмам.
...
- При включении лампы предупреждающий зуммер один раз звучит как «пон». Если после этого не заправить автомобиль, зуммер будет звучать при каждом переводе выключателя двигателя в положение `ON`.
- Если в системе есть неисправность, при положении выключателя двигателя `ON` лампа мигает. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.
...
Если в электронной системе управления ABS (антиблокировочной системой тормозов) есть неисправность, при положении выключателя двигателя `ON` загорается контрольная лампа. Пока лампа горит, ABS не работает. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.
...
!!! danger "Внимание"
    Если контрольная лампа ABS и контрольная лампа тормозной системы одновременно продолжают гореть, немедленно остановитесь в безопасном месте и обратитесь к дилеру Suzuki или представителю Suzuki.
...
- Если лампа загорается или мигает при работающем двигателе, обратитесь для проверки к дилеру Suzuki или представителю Suzuki.
...
Если в системе электроусилителя рулевого управления есть неисправность, лампа загорается при работающем двигателе. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.

- Если система исправна, при переводе выключателя двигателя в положение `ON` лампа загорается, а после запуска двигателя гаснет.

!!! warning "Осторожно"
    При неисправности электроусилителя рулевого управления его функция отключается, и рулевое колесо становится тяжелее. Управлять автомобилем можно, прикладывая большее усилие, но как можно скорее обратитесь для проверки к дилеру Suzuki или представителю Suzuki.
...
- Если лампа загорается при работающем двигателе, немедленно остановитесь в безопасном месте, заглушите двигатель и обратитесь к дилеру Suzuki или представителю Suzuki.
...
- Если система исправна, при переводе выключателя двигателя в положение `ON` лампа загорается, а после запуска двигателя гаснет.
- Если лампа загорается при работающем двигателе, возможен обрыв ремня или другая неисправность. Немедленно остановитесь в безопасном месте, заглушите двигатель для защиты аккумулятора и обратитесь к дилеру Suzuki или представителю Suzuki.
...
Если в системе автоматической коробки передач есть неисправность, при положении выключателя двигателя `ON` загорается контрольная лампа. Если лампа продолжает гореть или мигать, спокойно остановитесь в безопасном месте и обратитесь к дилеру Suzuki или представителю Suzuki.

Если после погасания лампа снова загорелась или начала мигать, обратитесь для проверки к дилеру Suzuki или представителю Suzuki.
...
Если в электронной системе управления кузовом есть неисправность, при положении выключателя двигателя `ON` эта лампа может загореться. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.

См. также: [система иммобилайзера](04-driving.md#система-иммобилайзера).

- Когда эта лампа загорается, возможна неисправность электронной системы управления кузовом или низкое напряжение свинцово-кислотного аккумулятора. Если лампа загорается даже при нормальном напряжении аккумулятора, обратитесь для проверки к дилеру Suzuki или представителю Suzuki.
...
!!! tip "Подсказка"
    Для защиты свинцово-кислотного аккумулятора контрольная лампа открытой двери или капота автоматически гаснет, если выполнены все условия ниже. Это функция энергосбережения аккумулятора.
...
Если в системе автоматического дальнего света есть неисправность, при положении выключателя двигателя `ON` лампа загорается жёлтым. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.
...
См. также: [временная остановка и неисправность передней камеры, переднего радара и ультразвуковых датчиков](04-driving.md#временная-остановка-и-неисправность-передней-камеры-переднего-радара-и-ультразвуковых-датчиков).
...
- Если система исправна, при переводе выключателя двигателя в положение `ON` лампа горит красным примерно 2 секунды, затем гаснет.
...
Лампа загорается, когда в бензиновом сажевом фильтре GPF накопилось определённое количество сажи. Чтобы лампа погасла, необходимо продолжать движение до завершения выжигания и удаления сажи, накопившейся в GPF.

Аббревиатура GPF обозначает бензиновый сажевый фильтр.
...
- Индикатор мигает при включении указателей поворота или аварийной сигнализации.
- Если мигание стало необычно быстрым, возможен перегоревший фонарь указателя поворота или аварийной сигнализации.

См. также: [замена ламп](07-emergency.md#замена-ламп).
...
- Если индикатор 4WD продолжает мигать, возможна неисправность системы. В этом случае переключить режим привода нельзя, и сохраняется текущий режим привода. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.

См. также: [рычаг раздаточной коробки и индикаторы](04-driving.md#рычаг-раздаточной-коробки-и-индикаторы).
...
См. также: [система ESP](04-driving.md#система-esp).
...
Если после достаточного прогрева индикатор продолжает гореть синим, возможна неисправность датчика. Если индикатор мигает синим, возможна неисправность системы. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.
...
См. также: [выключатель отключения системы поддержки торможения с двумя датчиками DSBS II](04-driving.md#выключатель-отключения-системы-поддержки-торможения-с-двумя-датчиками-dsbs-ii).
...
- Если в одной из перечисленных ниже электронных систем управления есть неисправность, при положении выключателя двигателя `ON` индикатор загорается. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki:
    - система поддержки торможения с двумя датчиками DSBS II;
    - функция предотвращения ошибочного начала движения;
    - поддержка торможения при движении вперёд на малой скорости;
    - поддержка торможения при движении назад;
    - функция предотвращения ошибочного начала движения назад.

См. также: [система поддержки торможения с двумя датчиками DSBS II](04-driving.md#система-поддержки-торможения-с-двумя-датчиками-dsbs-ii), [предотвращение ошибочного начала движения](04-driving.md#предотвращение-ошибочного-начала-движения), [поддержка торможения на малой скорости](04-driving.md#поддержка-торможения-на-малой-скорости), [предотвращение ошибочного начала движения назад](04-driving.md#предотвращение-ошибочного-начала-движения-назад).

##### Индикатор работы предотвращения схода с полосы

![Индикатор работы предотвращения схода с полосы](images/03-before-driving/84S301250.png){ .center-image }
...
- Когда работает предотвращение схода с полосы, индикатор горит зелёным.
- Когда работает предупреждение о сходе с полосы, индикатор мигает жёлтым.
- Если в одной из перечисленных ниже систем есть неисправность, индикатор горит жёлтым. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki:
    - предупреждение о сходе с полосы;
    - предотвращение схода с полосы;
    - предупреждение о вилянии автомобиля.

См. также: [предупреждение о сходе с полосы](04-driving.md#предупреждение-о-сходе-с-полосы), [предотвращение схода с полосы](04-driving.md#предотвращение-схода-с-полосы), [предупреждение о вилянии автомобиля](04-driving.md#предупреждение-о-вилянии-автомобиля).
...
- Индикатор загорается при длительном нажатии выключателя отключения предотвращения схода с полосы.

См. также: [выключатель отключения предотвращения схода с полосы](04-driving.md#выключатель-отключения-предотвращения-схода-с-полосы).
...
Индикатор горит, когда работает предотвращение схода с полосы. Цвет и режим индикации меняются в зависимости от состояния системы.

- Когда работает предотвращение схода с полосы, индикатор горит зелёным.

См. также: [предотвращение схода с полосы](04-driving.md#предотвращение-схода-с-полосы).
...
- Если в системе есть неисправность, при положении выключателя двигателя `ON` индикатор загорается. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.
- Если система исправна, при переводе выключателя двигателя в положение `ON` индикатор загорается на несколько секунд, затем гаснет.
...
- Если в системе есть неисправность, индикатор горит жёлтым. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.

См. также: [адаптивный круиз-контроль](04-driving.md#адаптивный-круиз-контроль), [адаптивный круиз-контроль с функцией следования до полной остановки](04-driving.md#адаптивный-круиз-контроль-с-функцией-следования-до-полной-остановки).
...
- Если запереть двери кнопкой запроса или системой дистанционного управления, индикатор начинает часто мигать, и примерно через 20 секунд охранная сигнализация становится на охрану.
...
- Если в электронной системе управления кузовом есть неисправность, при положении выключателя двигателя `ON` индикатор мигает с интервалом 1 секунда примерно 15 секунд. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.
...
См. также: [индикатор системы помощи при спуске](04-driving.md#индикатор-системы-помощи-при-спуске).
...
См. также: [выключатель отключения системы автоматической остановки двигателя](04-driving.md#выключатель-отключения-системы-автоматической-остановки-двигателя).
...
См. также: [система автоматической остановки двигателя](04-driving.md#система-автоматической-остановки-двигателя).

- Если индикатор отключения системы автоматической остановки двигателя мигает, как можно скорее обратитесь для проверки к дилеру Suzuki или представителю Suzuki.
- Если система исправна, при переводе выключателя двигателя в положение `ON` индикатор загорается примерно на 2 секунды, затем гаснет.
...
- Если в парковочных датчиках есть неисправность, при положении выключателя двигателя `ON` индикатор горит. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.
- Если система исправна, при переводе выключателя двигателя в положение `ON` индикатор загорается на несколько секунд, затем гаснет.
...
- Если при включении передачи `R` индикатор `R` не загорается, обратитесь для проверки к дилеру Suzuki или представителю Suzuki.
...
При переводе выключателя двигателя в положение `ON` на многофункциональном информационном дисплее на короткое время появляется заставка. Одновременно с заставкой звучит стартовый сигнал. После этого в каждой зоне дисплея отображается один из пунктов, приведённых ниже.

!!! tip "Подсказка"
    Настройку стартового сигнала можно изменить в режиме настроек.
...
![Часы и календарь](images/03-before-driving/69TJ040070.png){ .center-image }
...
| `YYYY.MM.DD` | `2023.12.28` | Год по западному календарю, месяц, день. Исходная заводская настройка |
...
См. также: [движение по снегу](06-care.md#движение-по-снегу).
...
После сброса отображения показываются средний расход топлива, средний расход за 5 минут в интервалах от 15 до 10 минут назад и от 5 минут назад до текущего момента, а также средний расход за одну поездку. При сбросе расхода топлива эти значения тоже сбрасываются.
...
На экране в реальном времени отображается изменение положения центра тяжести автомобиля. При обнаружении максимального ускорения или замедления на экране появляется датчик ускорения `G` в виде сферического индикатора (1).

После остановки автомобиля историю положения датчика ускорения `G`, записанную во время движения, можно просмотреть на графике (2).
...
| Обозначение | Элемент |
| --- | --- |
| (1) | Индикатор датчика ускорения `G` |
| (2) | График истории |
...
Отображается текущая манера управления: степень нажатия педали акселератора и педали тормоза показывается отдельными столбиковыми индикаторами.
...
!!! tip "Подсказка"
    ...
    Включайте и выключайте подсказки проезда перекрёстков, когда отображается функция подсказок навигации:
...
Если есть информация, которую нужно сообщить водителю, например неисправность какой-либо системы, на дисплее отображается сообщение. В зависимости от типа сообщения одновременно может звучать внутренний или наружный зуммер.
...
| --- | --- | --- | --- |
| ![Открыта дверь или капот](images/03-before-driving/77R31480.png)<br>При остановке автомобиля, см. примечание 1 | Не горит | Нет | Какая-либо дверь или капот закрыты не полностью.<br>Остановитесь в безопасном месте и полностью закройте дверь или капот.<br>См. также: [контрольная лампа открытой двери или капота](#контрольная-лампа-открытой-двери-или-капота). |
| ![Состояние питания ACC](images/03-before-driving/69T040140-acc.png)<br>«Состояние питания: ACC», см. примечание 1 | Не горит | Нет | Отображается, когда питание находится в режиме `ACC`.<br>См. также: [переключение режима питания](04-driving.md#переключение-режима-питания). |
...
| ![Переведите селектор в P и нажмите тормоз](images/03-before-driving/69T040230.png)<br>«Переведите селектор в `P` и нажмите педаль тормоза» | Не горит | Внутренний зуммер: одиночный сигнал, короткий прерывистый сигнал или непрерывный сигнал; также голосовая подсказка | Селектор находится не в положении `P` или `N`, либо выключатель двигателя нажат без нажатия педали тормоза. Следуйте указанию сообщения.<br>См. также: [запуск двигателя](04-driving.md#запуск-двигателя). |
| ![Нажмите тормоз и сцепление](images/03-before-driving/69TJ040670.png)<br>«Нажмите тормоз и сцепление» | Не горит | Внутренний зуммер: одиночный сигнал | Выключатель двигателя нажат без нажатия педали тормоза и педали сцепления. Следуйте указанию сообщения.<br>См. также: [запуск двигателя](04-driving.md#запуск-двигателя). |
...
| ![Проверьте блокировку рулевого колеса](images/03-before-driving/69T040160.png)<br>«Проверьте блокировку рулевого колеса» | Мигает | Внутренний зуммер: одиночный сигнал | Возможна неисправность блокировки рулевого колеса. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.<br>См. также: [возврат выключателя двигателя](04-driving.md#возврат-выключателя-двигателя). |
| ![Проверьте систему запуска](images/03-before-driving/69T040170.png)<br>«Проверьте систему запуска» | Мигает | Внутренний зуммер: одиночный сигнал | Возможна неисправность иммобилайзера или системы запуска без ключа, либо низкое напряжение свинцово-кислотной аккумуляторной батареи. Если сообщение отображается при нормальном напряжении батареи, обратитесь для проверки к дилеру Suzuki или представителю Suzuki.<br>См. также: [иммобилайзер](04-driving.md#иммобилайзер), [система запуска без ключа](04-driving.md#система-запуска-без-ключа). |
| ![Пульт не обнаружен](images/03-before-driving/69T040180.png)<br>«Пульт не обнаружен»<br><br>![Поднесите пульт к выключателю двигателя](images/03-before-driving/69T040190.png)<br>«Поднесите пульт к выключателю двигателя» | Мигает | Внутренний зуммер: одиночный сигнал; также голосовая подсказка | Вы управляете выключателем двигателя, когда пульт дистанционного управления не обнаружен или батарейка пульта разряжена. Разместите пульт в зоне обнаружения в салоне или приложите пульт к выключателю двигателя.<br>См. также: [рабочая зона в салоне](04-driving.md#рабочая-зона-в-салоне), [запуск двигателя](04-driving.md#запуск-двигателя). |
| ![Поднесите пульт к выключателю двигателя](images/03-before-driving/69T040190.png)<br>«Поднесите пульт к выключателю двигателя»<br><br>![Пульт не обнаружен](images/03-before-driving/69T040180.png)<br>«Пульт не обнаружен» | Мигает | Сначала внутренний и наружный зуммер: прерывистый сигнал; затем внутренний зуммер: одиночный сигнал | Когда выключатель двигателя был переведён в положение `ACC` или `ON`, пульт обнаруживался, но при запуске перестал обнаруживаться. Разместите пульт в зоне обнаружения в салоне и управляйте выключателем двигателя.<br>См. также: [рабочая зона в салоне](04-driving.md#рабочая-зона-в-салоне), [запуск двигателя](04-driving.md#запуск-двигателя). |
| ![Пульт не обнаружен](images/03-before-driving/69T040180.png)<br>«Пульт не обнаружен» | Мигает | Внутренний и наружный зуммер: короткий прерывистый сигнал; также голосовая подсказка | При работающем двигателе либо при положении выключателя двигателя `ACC` или `ON` была открыта или закрыта дверь, и пульт дистанционного управления перестал обнаруживаться, например оказался вне автомобиля. Верните пульт в зону обнаружения в салоне.<br>См. также: [предупреждение о выносе пульта из автомобиля](04-driving.md#предупреждение-о-выносе-пульта-из-автомобиля). |
| ![Включено освещение](images/03-before-driving/69T040100.png)<br>«Освещение включено» | Мигает | Внутренний зуммер: непрерывный сигнал; также голосовая подсказка | Включены фары или габаритные огни. Выключите их.<br>См. также: [зуммер предупреждения о невыключенном освещении](#зуммер-предупреждения-о-невыключенном-освещении). |

Примечание 1: сообщения с этой отметкой исчезают через определённое время, даже если причина сообщения не устранена.

##### Когда выключатель двигателя находится в положении ON

| Сообщение | Главная предупреждающая лампа | Зуммер | Что означает и что делать |
| --- | --- | --- | --- |
| ![Открыта дверь или капот](images/03-before-driving/77R31480.png)<br>При остановке автомобиля, см. примечание 1 | Мигает только во время движения | Во время движения: внутренний зуммер, длинный прерывистый сигнал; также голосовая подсказка | Какая-либо дверь или капот закрыты не полностью.<br>Остановитесь в безопасном месте и полностью закройте дверь или капот.<br>См. также: [контрольная лампа открытой двери или капота](#контрольная-лампа-открытой-двери-или-капота). |
| ![Состояние питания ON](images/03-before-driving/69T040140-on.png)<br>«Состояние питания: ON», см. примечание 1 | Не горит | Нет | Отображается, когда питание находится в режиме `ON`.<br>См. также: [переключение режима питания](04-driving.md#переключение-режима-питания). |
| ![Заправьте автомобиль](images/03-before-driving/69T040110.png)<br>«Заправьте автомобиль», см. примечание 1 | Не горит | Внутренний зуммер: одиночный сигнал; также голосовая подсказка | Остаток топлива мал. Как можно скорее заправьте автомобиль.<br>См. также: [контрольная лампа низкого уровня топлива](#контрольная-лампа-низкого-уровня-топлива). |
| ![Нажмите выключатель двигателя](images/03-before-driving/69T040150.png)<br>«Нажмите выключатель двигателя» | Не горит | Нет | Автомобиль с механической коробкой передач: нажата педаль сцепления.<br>Автомобиль с автоматической коробкой передач: нажата педаль тормоза.<br>Чтобы запустить двигатель, нажмите выключатель двигателя.<br>См. также: [запуск двигателя](04-driving.md#запуск-двигателя). |
| ![Переведите селектор в P и нажмите тормоз](images/03-before-driving/69T040230.png)<br>«Переведите селектор в `P` и нажмите педаль тормоза» | Не горит | Внутренний зуммер: одиночный сигнал, короткий прерывистый сигнал или непрерывный сигнал; также голосовая подсказка | Селектор находится не в положении `P` или `N`, и выключатель двигателя нажат при нажатой педали тормоза. Следуйте указанию сообщения.<br>См. также: [запуск двигателя](04-driving.md#запуск-двигателя).<br><br>Также сообщение отображается, если при перемещении селектора не включилась нужная передача. Нажмите педаль тормоза, переведите селектор в `P`, затем снова выполните переключение.<br>См. также: [управление селектором](04-driving.md#управление-селектором). |
| ![Нажмите тормоз и сцепление](images/03-before-driving/69TJ040670.png)<br>«Нажмите тормоз и сцепление» | Не горит | Внутренний зуммер: одиночный сигнал | Выключатель двигателя нажат без нажатия педали тормоза и педали сцепления. Следуйте указанию сообщения.<br>См. также: [запуск двигателя](04-driving.md#запуск-двигателя). |
| ![Проверьте блокировку рулевого колеса](images/03-before-driving/69T040160.png)<br>«Проверьте блокировку рулевого колеса» | Мигает | Внутренний зуммер: одиночный сигнал | Возможна неисправность блокировки рулевого колеса. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.<br>См. также: [возврат выключателя двигателя](04-driving.md#возврат-выключателя-двигателя). |
| ![Поверните рулевое колесо и нажмите выключатель двигателя](images/03-before-driving/84S304190.png)<br>«Поворачивая рулевое колесо вправо-влево, нажмите выключатель двигателя», см. примечание 1 | Мигает | Внутренний зуммер: одиночный сигнал; также голосовая подсказка | Блокировка рулевого колеса не снята. Поворачивая рулевое колесо вправо-влево, повторите операцию с выключателем двигателя.<br>См. также: [если блокировка рулевого колеса не снимается](04-driving.md#если-блокировка-рулевого-колеса-не-снимается). |
| ![Проверьте систему запуска](images/03-before-driving/69T040170.png)<br>«Проверьте систему запуска» | Мигает | Внутренний зуммер: одиночный сигнал | Возможна неисправность иммобилайзера или системы запуска без ключа, либо низкое напряжение свинцово-кислотной аккумуляторной батареи. Если сообщение отображается при нормальном напряжении батареи, обратитесь для проверки к дилеру Suzuki или представителю Suzuki.<br>См. также: [иммобилайзер](04-driving.md#иммобилайзер), [система запуска без ключа](04-driving.md#система-запуска-без-ключа). |
| ![Замените батарейку пульта](images/03-before-driving/69T040210.png)<br>«Замените батарейку пульта», см. примечание 2 | Не горит | Внутренний зуммер: одиночный сигнал; также голосовая подсказка | Батарейка пульта дистанционного управления почти разряжена. Замените батарейку.<br>См. также: [замена батарейки пульта](06-care.md#замена-батарейки-пульта). |
| ![Пульт не обнаружен](images/03-before-driving/69T040180.png)<br>«Пульт не обнаружен»<br><br>![Поднесите пульт к выключателю двигателя](images/03-before-driving/69T040190.png)<br>«Поднесите пульт к выключателю двигателя» | Мигает | Внутренний и наружный зуммер: короткий прерывистый сигнал; также голосовая подсказка<br>или<br>внутренний зуммер: одиночный сигнал; также голосовая подсказка | Пульт дистанционного управления не находится в салоне или его батарейка разряжена. Верните пульт в салон или приложите пульт к выключателю двигателя.<br>См. также: [предупреждение о выносе пульта из автомобиля](04-driving.md#предупреждение-о-выносе-пульта-из-автомобиля), [запуск двигателя](04-driving.md#запуск-двигателя). |
| ![Ремень безопасности пассажира](images/03-before-driving/84S304220.png)<br>«Пристегните ремень безопасности пассажира» | Мигает | Внутренний зуммер: длинный прерывистый сигнал | Пассажир на переднем сиденье не пристёгнут ремнём безопасности. Пристегните ремень.<br>См. также: [сигнализатор непристёгнутого ремня безопасности](#сигнализатор-непристёгнутого-ремня-безопасности). |
| ![Ремень безопасности](images/03-before-driving/84S304220.png)<br>«Пристегните ремень безопасности» | Мигает | Внутренний зуммер: длинный прерывистый сигнал | Водитель не пристёгнут ремнём безопасности. Остановитесь в безопасном месте и пристегните ремень.<br>См. также: [сигнализатор непристёгнутого ремня безопасности](#сигнализатор-непристёгнутого-ремня-безопасности). |
| ![Проверьте систему ESP](images/03-before-driving/77R31540.png)<br>«Проверьте систему ESP» | Мигает | Внутренний зуммер: одиночный сигнал | Возможна неисправность системы ESP. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.<br>См. также: [система ESP](04-driving.md#система-esp). |
| ![Система удержания на подъёме остановлена](images/03-before-driving/77R31540.png)<br>«Функция удержания на подъёме остановлена» | Мигает | Внутренний зуммер: одиночный сигнал | Если это сообщение отображается, когда система удержания на подъёме не отключалась, возможна неисправность системы. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.<br>См. также: [система удержания на подъёме](04-driving.md#система-удержания-на-подъёме). |
| ![Предупреждение о вилянии автомобиля](images/03-before-driving/84S304240.png)<br>«Внимание: виляние автомобиля», см. примечание 1 | Не горит | Внутренний зуммер: короткий прерывистый сигнал | Работает функция предупреждения о вилянии автомобиля.<br>См. также: [предупреждение о вилянии автомобиля](04-driving.md#предупреждение-о-вилянии-автомобиля). |
| ![Впереди стоящий автомобиль тронулся](images/03-before-driving/84S304300.png)<br>«Впереди стоящий автомобиль тронулся»<br><br>![Сигнал светофора изменился](images/03-before-driving/84S304250.png)<br>«Сигнал светофора изменился» | Не горит | Внутренний зуммер: короткий прерывистый сигнал | Работает функция напоминания о начале движения.<br>См. также: [напоминание о начале движения](04-driving.md#напоминание-о-начале-движения). |
| «Система поддержки торможения с двумя датчиками DSBS II выключена» | Мигает | Внутренний зуммер: одиночный сигнал | Система поддержки торможения с двумя датчиками DSBS II, функция предотвращения ошибочного начала движения, поддержка торможения на малой скорости при движении вперёд и назад и функция предотвращения ошибочного начала движения назад остановлены.<br>См. также: [выключатель отключения системы поддержки торможения с двумя датчиками DSBS II](04-driving.md#выключатель-отключения-системы-поддержки-торможения-с-двумя-датчиками-dsbs-ii). |
| «Из-за отключения ESP система поддержки торможения с двумя датчиками DSBS II тоже остановится» | Мигает | Внутренний зуммер: одиночный сигнал | Система поддержки торможения с двумя датчиками DSBS II остановлена.<br>См. также: [выключатель ESP OFF](04-driving.md#выключатель-esp-off). |
| ![LDP недоступна на текущей скорости](images/03-before-driving/84S304240.png)<br>«Система LDP недоступна на текущей скорости», см. примечание 1 | Не горит | Нет | Скорость автомобиля находится вне верхнего диапазона работы функции предотвращения схода с полосы, поэтому функция не работает.<br>См. также: [предотвращение схода с полосы](04-driving.md#предотвращение-схода-с-полосы). |
| ![Повторяющийся сход с полосы](images/03-before-driving/69TJ040610.png)<br>«Повторяющийся сход с полосы. Управляйте рулевым колесом» | Мигает | Внутренний зуммер: прерывистый сигнал | Водитель не держит рулевое колесо или не выполняет руление. Держите рулевое колесо и управляйте автомобилем.<br>См. также: [предотвращение схода с полосы](04-driving.md#предотвращение-схода-с-полосы). |
| «Проверьте систему DSBS II» | Мигает | Внутренний зуммер: одиночный сигнал | Возможна неисправность системы поддержки торможения с двумя датчиками DSBS II. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.<br>См. также: [система поддержки торможения с двумя датчиками DSBS II](04-driving.md#система-поддержки-торможения-с-двумя-датчиками-dsbs-ii). |
| ![Нажмите тормоз после срабатывания торможения](images/03-before-driving/69TJ040530.png)<br>«Нажата педаль акселератора. Нажмите педаль тормоза» | Мигает | Внутренний зуммер: короткий прерывистый сигнал | Автомобиль удерживается остановленным после срабатывания торможения для уменьшения ущерба при столкновении, когда нажата педаль акселератора.<br>См. также: [торможение для уменьшения ущерба при столкновении](04-driving.md#торможение-для-уменьшения-ущерба-при-столкновении). |
| ![Нажата педаль акселератора](images/03-before-driving/69TJ040530.png)<br>«Нажата педаль акселератора» | Мигает | Внутренний зуммер: короткий прерывистый сигнал | Работает функция предотвращения ошибочного начала движения.<br>См. также: [предотвращение ошибочного начала движения](04-driving.md#предотвращение-ошибочного-начала-движения). |
| ![Нажмите тормоз после поддержки при малой скорости](images/03-before-driving/69TJ040530.png)<br>«Нажата педаль акселератора. Нажмите педаль тормоза» | Мигает | Внутренний зуммер: короткий прерывистый сигнал | Автомобиль удерживается остановленным после срабатывания поддержки торможения при движении вперёд на малой скорости, когда нажата педаль акселератора.<br>См. также: [поддержка торможения на малой скорости](04-driving.md#поддержка-торможения-на-малой-скорости). |
| ![Нажмите тормоз](images/03-before-driving/69TJ040530.png)<br>«Нажмите педаль тормоза» | Мигает | Внутренний зуммер: короткий прерывистый сигнал | Автомобиль удерживается остановленным после срабатывания поддержки торможения при движении вперёд на малой скорости, когда педаль акселератора не нажата.<br>См. также: [поддержка торможения на малой скорости](04-driving.md#поддержка-торможения-на-малой-скорости). |
| ![Нажмите тормоз после поддержки при движении назад](images/03-before-driving/69TJ040540.png)<br>«Нажата педаль акселератора. Нажмите педаль тормоза» | Мигает | Внутренний зуммер: короткий прерывистый сигнал | Автомобиль удерживается остановленным после срабатывания поддержки торможения при движении назад, когда нажата педаль акселератора.<br>См. также: [поддержка торможения на малой скорости](04-driving.md#поддержка-торможения-на-малой-скорости). |
| ![Нажмите тормоз после поддержки при движении назад](images/03-before-driving/69TJ040540.png)<br>«Нажмите педаль тормоза» | Мигает | Внутренний зуммер: короткий прерывистый сигнал | Автомобиль удерживается остановленным после срабатывания поддержки торможения при движении назад, когда педаль акселератора не нажата.<br>См. также: [поддержка торможения на малой скорости](04-driving.md#поддержка-торможения-на-малой-скорости). |
| ![Нажата педаль акселератора при движении назад](images/03-before-driving/69TJ040540.png)<br>«Нажата педаль акселератора» | Мигает | Внутренний зуммер: короткий прерывистый сигнал | Работает функция предотвращения ошибочного начала движения назад.<br>См. также: [предотвращение ошибочного начала движения назад](04-driving.md#предотвращение-ошибочного-начала-движения-назад). |
| «Система DSBS II временно остановлена» | Не горит | Нет | Работа переднего радара и передней камеры временно приостановлена.<br>См. также: [временная остановка и неисправность передней камеры, переднего радара и ультразвуковых датчиков](04-driving.md#временная-остановка-и-неисправность-передней-камеры-переднего-радара-и-ультразвуковых-датчиков). |
| «Передняя камера временно остановлена (вне диапазона температуры)» | Мигает | Внутренний зуммер: одиночный сигнал | Работа передней камеры временно приостановлена из-за слишком низкой или слишком высокой температуры камеры.<br>См. также: [временная остановка и неисправность передней камеры, переднего радара и ультразвуковых датчиков](04-driving.md#временная-остановка-и-неисправность-передней-камеры-переднего-радара-и-ультразвуковых-датчиков). |
| «Передняя камера временно остановлена (плохая видимость)», см. примечание 1 | Не горит | Нет | Работа передней камеры временно приостановлена из-за плохой видимости.<br>См. также: [временная остановка и неисправность передней камеры, переднего радара и ультразвуковых датчиков](04-driving.md#временная-остановка-и-неисправность-передней-камеры-переднего-радара-и-ультразвуковых-датчиков). |
| «Передний радар временно остановлен (загрязнение)», см. примечание 1 | Не горит | Нет | Работа переднего радара временно приостановлена из-за загрязнения переднего радара.<br>См. также: [временная остановка и неисправность передней камеры, переднего радара и ультразвуковых датчиков](04-driving.md#временная-остановка-и-неисправность-передней-камеры-переднего-радара-и-ультразвуковых-датчиков). |
| «Передний радар временно остановлен (вне диапазона температуры)» | Мигает | Внутренний зуммер: одиночный сигнал | Работа переднего радара временно приостановлена из-за слишком низкой или слишком высокой температуры блока радара.<br>См. также: [временная остановка и неисправность передней камеры, переднего радара и ультразвуковых датчиков](04-driving.md#временная-остановка-и-неисправность-передней-камеры-переднего-радара-и-ультразвуковых-датчиков). |
| «Передний радар временно остановлен (настройка направления)», см. примечание 1 | Не горит | Нет | Работа переднего радара временно приостановлена из-за смещения направления переднего радара относительно автомобиля.<br>См. также: [временная остановка и неисправность передней камеры, переднего радара и ультразвуковых датчиков](04-driving.md#временная-остановка-и-неисправность-передней-камеры-переднего-радара-и-ультразвуковых-датчиков). |
| «Ультразвуковые датчики временно остановлены» | Мигает | Внутренний зуммер: одиночный сигнал | Работа ультразвуковых датчиков временно приостановлена.<br>См. также: [когда ультразвуковые датчики могут работать неправильно](04-driving.md#когда-ультразвуковые-датчики-могут-работать-неправильно). |
| «Проверьте ультразвуковые датчики» | Мигает | Внутренний зуммер: одиночный сигнал | Возможна неисправность ультразвуковых датчиков. Если после перезапуска двигателя сообщение отображается снова, обратитесь к дилеру Suzuki или представителю Suzuki.<br>См. также: [когда ультразвуковые датчики могут работать неправильно](04-driving.md#когда-ультразвуковые-датчики-могут-работать-неправильно). |
| ![Система поддержки торможения с двумя датчиками DSBS II](images/03-before-driving/69TJ040530.png)<br>«Система поддержки торможения с двумя датчиками DSBS II» | Мигает | Внутренний зуммер: короткий прерывистый сигнал | Работает предупреждение о фронтальном столкновении, помощь при торможении для уменьшения ущерба при фронтальном столкновении или торможение для уменьшения ущерба при столкновении.<br>См. также: [предупреждение о фронтальном столкновении](04-driving.md#предупреждение-о-фронтальном-столкновении), [помощь при торможении для уменьшения ущерба при фронтальном столкновении](04-driving.md#помощь-при-торможении-для-уменьшения-ущерба-при-фронтальном-столкновении), [торможение для уменьшения ущерба при столкновении](04-driving.md#торможение-для-уменьшения-ущерба-при-столкновении). |
| ![Поддержка торможения на малой скорости вперёд](images/03-before-driving/69TJ040530.png) | Не горит | Внутренний зуммер: короткий прерывистый сигнал | Работает поддержка торможения при движении вперёд на малой скорости.<br>См. также: [поддержка торможения на малой скорости](04-driving.md#поддержка-торможения-на-малой-скорости). |
| ![Поддержка торможения на малой скорости назад](images/03-before-driving/69TJ040540.png) | Не горит | Внутренний зуммер: короткий прерывистый сигнал | Работает поддержка торможения при движении назад на малой скорости.<br>См. также: [поддержка торможения на малой скорости](04-driving.md#поддержка-торможения-на-малой-скорости). |
| ![Проверьте систему парковочных датчиков](images/03-before-driving/84S304310.png)<br>«Проверьте систему парковочных датчиков» | Мигает | Внутренний зуммер: одиночный сигнал | Возможна неисправность ультразвуковых датчиков. Если после перезапуска двигателя сообщение отображается снова, обратитесь к дилеру Suzuki или представителю Suzuki.<br>См. также: [временная остановка и неисправность передней камеры, переднего радара и ультразвуковых датчиков](04-driving.md#временная-остановка-и-неисправность-передней-камеры-переднего-радара-и-ультразвуковых-датчиков). |
...
| ![Парковочные датчики: длинный интервал](images/03-before-driving/77R31490.png) | Не горит | Внутренний зуммер: длинный прерывистый сигнал или прерывистый сигнал | Ультразвуковые датчики обнаруживают препятствие.<br>См. также: [парковочные датчики](04-driving.md#парковочные-датчики). |
| ![Парковочные датчики: короткий интервал](images/03-before-driving/77R31500.png) | Не горит | Внутренний зуммер: короткий прерывистый сигнал | Ультразвуковые датчики обнаруживают препятствие.<br>См. также: [парковочные датчики](04-driving.md#парковочные-датчики). |
| ![Парковочные датчики: непрерывный сигнал](images/03-before-driving/84S304130.png) | Не горит | Внутренний зуммер: непрерывный сигнал | Ультразвуковые датчики обнаруживают препятствие.<br>См. также: [парковочные датчики](04-driving.md#парковочные-датчики). |
| ![Проверьте систему GPF](images/03-before-driving/69T040270.png)<br>«Проверьте систему GPF» | Мигает | Внутренний зуммер: одиночный сигнал | Возможна неисправность бензинового сажевого фильтра GPF. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.<br>GPF: бензиновый сажевый фильтр. |
| ![Выполните поездку для регенерации GPF](images/03-before-driving/69T040270.png)<br>«Выполните поездку для регенерации GPF» | Мигает | Внутренний зуммер: одиночный сигнал | Чтобы сжечь и удалить сажу, накопившуюся в GPF, необходимо проехать на автомобиле.<br>См. также: [бензиновый сажевый фильтр GPF](04-driving.md#бензиновый-сажевый-фильтр-gpf). |
| ![Проверьте систему экстренного вызова](images/03-before-driving/84S304290.png)<br>«Проверьте систему экстренного вызова» | Мигает | Нет | Возможна неисправность системы экстренного вызова Suzuki. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.<br>См. также: [система экстренного вызова Suzuki Help Net](07-emergency.md#система-экстренного-вызова-suzuki-help-net). |

Примечание 1: сообщения с этой отметкой исчезают через определённое время, даже если причина сообщения не устранена.

Примечание 2: отображение этого сообщения можно изменить в режиме настроек. См. также: [режим настроек](08-service-data.md#режим-настроек).
...
- Когда выключатель двигателя находится в положении `ON`, а снаружи достаточно темно для автоматического включения фар:
    ...
    - даже в этих условиях, если автомобиль остановлен, можно выключить только фары. См. [примечание 1](#примечание-1-к-переключателю-освещения).
...
- Когда выключатель двигателя находится в положении `ON`, а снаружи достаточно темно для автоматического включения фар:
    ...
    - даже при отпущенном стояночном тормозе, если автомобиль остановлен, можно выключить только фары. См. [примечание 1](#примечание-1-к-переключателю-освещения).
...
- Когда выключатель двигателя находится в положении `ON`, а снаружи достаточно темно для автоматического включения фар:
    ...
    - даже если селектор находится не в положении `P` и стояночный тормоз отпущен, но автомобиль остановлен, можно выключить только фары. См. [примечание 1](#примечание-1-к-переключателю-освещения).

<a id="примечание-1-к-переключателю-освещения"></a>

!!! info "Примечание 1"
    Если автомобиль остановлен, даже в перечисленных ниже условиях можно выключить только фары: верните ручку переключателя освещения (1) из положения `OFF` в положение `AUTO`, затем быстро переведите её в положение габаритных огней.
...
Чтобы не забыть выключить фары или габаритные огни, внутренний зуммер непрерывно звучит при открывании двери водителя в следующих случаях.

Автомобили без системы запуска без ключа:

- после извлечения ключа включены фары или габаритные огни.

Автомобили с системой запуска без ключа:

- после перевода выключателя двигателя в положение `LOCK (OFF)` включены фары или габаритные огни.

Внутренний зуммер прекращает звучать, когда фары и габаритные огни выключены.
...
!!! info "Примечание"
    ...
    См. также: [список сообщений многофункционального информационного дисплея](#список-сообщений-многофункционального-информационного-дисплея).
...
Выключатель можно использовать независимо от положения выключателя двигателя. Используйте аварийную сигнализацию при вынужденной остановке на дороге из-за неисправности и в других аварийных ситуациях.

- При нажатии выключателя мигают все указатели поворота и индикаторы указателей поворота в комбинации приборов.
- При повторном нажатии аварийная сигнализация выключается.

![Выключатель аварийной сигнализации](images/03-before-driving/77R31450.png){ .center-image }

!!! info "Примечание"
    Не оставляйте аварийную сигнализацию включённой надолго при неработающем двигателе. Это может привести к разряду свинцово-кислотной аккумуляторной батареи.
...
!!! warning "Осторожно"
    ...
    См. также: [обдув ветрового стекла](05-equipment.md#обдув-ветрового-стекла).
...
Если стеклоочиститель не работает даже после ожидания, возможна другая причина неисправности. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.
