...
SRS означает дополнительную удерживающую систему.
...
Подушки безопасности, которые не сработали, перед утилизацией необходимо привести в действие по установленной процедуре.
...
На экране в реальном времени отображается изменение ускорения автомобиля. При максимальном ускорении или замедлении на экране появляется индикатор перегрузки `G` в виде шарика (1).
...
| ![Проверьте блокировку рулевого колеса](images/03-before-driving/69T040160.png)<br>«Проверьте блокировку рулевого колеса» | Мигает | Зуммер в салоне: одиночный сигнал | Возможна неисправность блокировки рулевого колеса. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.<br>См. также: [возврат выключателя двигателя](04-driving.md#когда-переводите-выключатель-двигателя-в-lock). |
| ![Проверьте систему запуска](images/03-before-driving/69T040170.png)<br>«Проверьте систему запуска» | Мигает | Зуммер в салоне: одиночный сигнал | Возможна неисправность иммобилайзера или системы бесключевого запуска кнопкой, либо низкое напряжение свинцово-кислотной аккумуляторной батареи. Если сообщение отображается при нормальном напряжении батареи, обратитесь для проверки к дилеру Suzuki или представителю Suzuki.<br>См. также: [иммобилайзер](04-driving.md#система-иммобилайзера), [система бесключевого запуска кнопкой](04-driving.md#система-бесключевого-запуска-кнопкой). |
...
| ![Заправьте автомобиль](images/03-before-driving/69T040110.png)<br>«Заправьте автомобиль», см. примечание 1 | Не горит | Зуммер в салоне: одиночный сигнал; также голосовая подсказка | Остаток топлива мал. Как можно скорее заправьте автомобиль.<br>См. также: [контрольная лампа низкого уровня топлива](#контрольная-лампа-низкого-уровня-топлива). |
| ![Нажмите выключатель двигателя](images/03-before-driving/69T040150.png)<br>«Нажмите выключатель двигателя» | Не горит | Нет | Автомобиль с механической коробкой передач: нажата педаль сцепления.<br>Автомобиль с автоматической коробкой передач: нажата педаль тормоза.<br>Чтобы запустить двигатель, нажмите выключатель двигателя.<br>См. также: [запуск двигателя](04-driving.md#запуск-двигателя). |
...
| ![Нажмите тормоз и сцепление](images/03-before-driving/69TJ040670.png)<br>«Нажмите тормоз и сцепление» | Не горит | Зуммер в салоне: одиночный сигнал | Выключатель двигателя нажат без нажатия педали тормоза и педали сцепления. Следуйте указанию сообщения.<br>См. также: [запуск двигателя](04-driving.md#запуск-двигателя). |
| ![Проверьте блокировку рулевого колеса](images/03-before-driving/69T040160.png)<br>«Проверьте блокировку рулевого колеса» | Мигает | Зуммер в салоне: одиночный сигнал | Возможна неисправность блокировки рулевого колеса. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.<br>См. также: [возврат выключателя двигателя](04-driving.md#когда-переводите-выключатель-двигателя-в-lock). |
| ![Поверните рулевое колесо и нажмите выключатель двигателя](images/03-before-driving/84S304190.png)<br>«Поворачивая рулевое колесо вправо-влево, нажмите выключатель двигателя», см. примечание 1 | Мигает | Зуммер в салоне: одиночный сигнал; также голосовая подсказка | Блокировка рулевого колеса не снята. Поворачивая рулевое колесо вправо-влево, повторите операцию с выключателем двигателя.<br>См. также: [если блокировка рулевого колеса не снимается](04-driving.md#если-блокировка-рулевой-колонки-не-снимается). |
| ![Проверьте систему запуска](images/03-before-driving/69T040170.png)<br>«Проверьте систему запуска» | Мигает | Зуммер в салоне: одиночный сигнал | Возможна неисправность иммобилайзера или системы бесключевого запуска кнопкой, либо низкое напряжение свинцово-кислотной аккумуляторной батареи. Если сообщение отображается при нормальном напряжении батареи, обратитесь для проверки к дилеру Suzuki или представителю Suzuki.<br>См. также: [иммобилайзер](04-driving.md#система-иммобилайзера), [система бесключевого запуска кнопкой](04-driving.md#система-бесключевого-запуска-кнопкой). |
| ![Замените элемент питания пульта](images/03-before-driving/69T040210.png)<br>«Замените элемент питания пульта», см. примечание 2 | Не горит | Зуммер в салоне: одиночный сигнал; также голосовая подсказка | Элемент питания пульта дистанционного управления почти разряжен. Замените элемент питания.<br>См. также: [замена элемента питания пульта](06-care.md#замена-элемента-питания-пульта-дистанционного-управления). |
...
| ![Ремень безопасности пассажира](images/03-before-driving/84S304220.png)<br>«Пристегните ремень безопасности пассажира» | Мигает | Зуммер в салоне: длинный прерывистый сигнал | Пассажир на переднем сиденье не пристёгнут ремнём безопасности. Пристегните ремень.<br>См. также: [сигнализатор непристёгнутого ремня безопасности](#сигнализатор-непристёгнутого-ремня-безопасности). |
| ![Ремень безопасности](images/03-before-driving/84S304220.png)<br>«Пристегните ремень безопасности» | Мигает | Зуммер в салоне: длинный прерывистый сигнал | Водитель не пристёгнут ремнём безопасности. Остановитесь в безопасном месте и пристегните ремень.<br>См. также: [сигнализатор непристёгнутого ремня безопасности](#сигнализатор-непристёгнутого-ремня-безопасности). |
| ![Проверьте систему ESP](images/03-before-driving/77R31540.png)<br>«Проверьте систему ESP» | Мигает | Зуммер в салоне: одиночный сигнал | Возможна неисправность системы ESP. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.<br>См. также: [система ESP](04-driving.md#esp). |
...
| ![Предупреждение о вилянии автомобиля](images/03-before-driving/84S304240.png)<br>«Внимание: виляние автомобиля», см. примечание 1 | Не горит | Зуммер в салоне: короткий прерывистый сигнал | Работает функция предупреждения о вилянии автомобиля.<br>См. также: [предупреждение о вилянии автомобиля](04-driving.md#предупреждение-о-вилянии). |
...
| «Система поддержки торможения с двумя датчиками DSBS II выключена» | Мигает | Зуммер в салоне: одиночный сигнал | Система поддержки торможения с двумя датчиками DSBS II, функция предотвращения ошибочного начала движения, поддержка торможения на малой скорости при движении вперёд и назад и функция предотвращения ошибочного начала движения назад остановлены.<br>См. также: [выключатель отключения системы поддержки торможения с двумя датчиками DSBS II](04-driving.md#выключатель-off-системы-поддержки-торможения-с-двумя-датчиками-dsbs-ii). |
...
| «Проверьте систему DSBS II» | Мигает | Зуммер в салоне: одиночный сигнал | Возможна неисправность системы поддержки торможения с двумя датчиками DSBS II. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.<br>См. также: [система поддержки торможения с двумя датчиками DSBS II](04-driving.md#система-поддержки-торможения-с-двумя-датчиками-dsbs-ii). |
...
| ![Нажмите тормоз после поддержки при малой скорости](images/03-before-driving/69TJ040530.png)<br>«Нажата педаль акселератора. Нажмите педаль тормоза» | Мигает | Зуммер в салоне: короткий прерывистый сигнал | Автомобиль удерживается остановленным после срабатывания поддержки торможения при движении вперёд на малой скорости, когда нажата педаль акселератора.<br>См. также: [поддержка торможения на малой скорости](04-driving.md#поддержка-торможения-на-малой-скорости-при-движении-вперёд-и-назад). |
| ![Нажмите тормоз](images/03-before-driving/69TJ040530.png)<br>«Нажмите педаль тормоза» | Мигает | Зуммер в салоне: короткий прерывистый сигнал | Автомобиль удерживается остановленным после срабатывания поддержки торможения при движении вперёд на малой скорости, когда педаль акселератора не нажата.<br>См. также: [поддержка торможения на малой скорости](04-driving.md#поддержка-торможения-на-малой-скорости-при-движении-вперёд-и-назад). |
| ![Нажмите тормоз после поддержки при движении назад](images/03-before-driving/69TJ040540.png)<br>«Нажата педаль акселератора. Нажмите педаль тормоза» | Мигает | Зуммер в салоне: короткий прерывистый сигнал | Автомобиль удерживается остановленным после срабатывания поддержки торможения при движении назад, когда нажата педаль акселератора.<br>См. также: [поддержка торможения на малой скорости](04-driving.md#поддержка-торможения-на-малой-скорости-при-движении-вперёд-и-назад). |
| ![Нажмите тормоз после поддержки при движении назад](images/03-before-driving/69TJ040540.png)<br>«Нажмите педаль тормоза» | Мигает | Зуммер в салоне: короткий прерывистый сигнал | Автомобиль удерживается остановленным после срабатывания поддержки торможения при движении назад, когда педаль акселератора не нажата.<br>См. также: [поддержка торможения на малой скорости](04-driving.md#поддержка-торможения-на-малой-скорости-при-движении-вперёд-и-назад). |
...
| «Проверьте ультразвуковые датчики» | Мигает | Зуммер в салоне: одиночный сигнал | Возможна неисправность ультразвуковых датчиков. Если после перезапуска двигателя сообщение отображается снова, обратитесь к дилеру Suzuki или представителю Suzuki.<br>См. также: [когда ультразвуковые датчики могут работать неправильно](04-driving.md#когда-ультразвуковые-датчики-могут-работать-неправильно). |
...
| ![Поддержка торможения на малой скорости вперёд](images/03-before-driving/69TJ040530.png) | Не горит | Зуммер в салоне: короткий прерывистый сигнал | Работает поддержка торможения при движении вперёд на малой скорости.<br>См. также: [поддержка торможения на малой скорости](04-driving.md#поддержка-торможения-на-малой-скорости-при-движении-вперёд-и-назад). |
| ![Поддержка торможения на малой скорости назад](images/03-before-driving/69TJ040540.png) | Не горит | Зуммер в салоне: короткий прерывистый сигнал | Работает поддержка торможения при движении назад на малой скорости.<br>См. также: [поддержка торможения на малой скорости](04-driving.md#поддержка-торможения-на-малой-скорости-при-движении-вперёд-и-назад). |
| ![Проверьте систему парковочных датчиков](images/03-before-driving/84S304310.png)<br>«Проверьте систему парковочных датчиков» | Мигает | Зуммер в салоне: одиночный сигнал | Возможна неисправность ультразвуковых датчиков. Если после перезапуска двигателя сообщение отображается снова, обратитесь к дилеру Suzuki или представителю Suzuki.<br>См. также: [временная остановка и неисправность передней камеры, переднего радара и ультразвуковых датчиков](04-driving.md#временная-остановка-или-неисправность-передней-камеры-переднего-радара-и-ультразвуковых-датчиков). |
...
| ![Проверьте систему GPF](images/03-before-driving/69T040270.png)<br>«Проверьте систему GPF» | Мигает | Зуммер в салоне: одиночный сигнал | Возможна неисправность бензинового сажевого фильтра GPF. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.<br>GPF: бензиновый сажевый фильтр. |
...
| ![Проверьте систему экстренного вызова](images/03-before-driving/84S304290.png)<br>«Проверьте систему экстренного вызова» | Мигает | Нет | Возможна неисправность системы экстренного вызова Suzuki. Обратитесь для проверки к дилеру Suzuki или представителю Suzuki.<br>См. также: [система экстренного вызова Suzuki Helpnet®](07-emergency.md#система-экстренного-вызова-suzuki-helpnet). |
